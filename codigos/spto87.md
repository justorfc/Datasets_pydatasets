```python
# Código Colab para dataset: spto87
...
try:
    try:
        df = pd.read_csv('data/spto87.csv')
        print('Cargado desde data/spto87.csv')
    except Exception:
        df = pd.read_excel('data/spto87.xlsx', engine='openpyxl')
        print('Cargado desde data/spto87.xlsx')
except Exception:
    try:
