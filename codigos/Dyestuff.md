```python
# Código Colab para dataset: Dyestuff
...
try:
    try:
        df = pd.read_csv('data/Dyestuff.csv')
        print('Cargado desde data/Dyestuff.csv')
    except Exception:
        df = pd.read_excel('data/Dyestuff.xlsx', engine='openpyxl')
        print('Cargado desde data/Dyestuff.xlsx')
except Exception:
    try:
