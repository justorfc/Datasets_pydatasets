```python
# Código Colab para dataset: OldMaps
...
try:
    try:
        df = pd.read_csv('data/OldMaps.csv')
        print('Cargado desde data/OldMaps.csv')
    except Exception:
        df = pd.read_excel('data/OldMaps.xlsx', engine='openpyxl')
        print('Cargado desde data/OldMaps.xlsx')
except Exception:
    try:
