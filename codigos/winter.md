```python
# Código Colab para dataset: winter
...
try:
    try:
        ...
        print('Cargado desde data/winter.csv')
    except Exception:
        df = pd.read_excel('data/winter.xlsx', engine='openpyxl')
        print('Cargado desde data/winter.xlsx')
except Exception:
    try:
