```python
# Código Colab para dataset: Suicide
...
try:
    try:
        ...
        print('Cargado desde data/Suicide.csv')
    except Exception:
        df = pd.read_excel('data/Suicide.xlsx', engine='openpyxl')
        print('Cargado desde data/Suicide.xlsx')
except Exception:
    try:
