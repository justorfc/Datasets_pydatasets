```python
# Código Colab para dataset: Florida
...
try:
    try:
        df = pd.read_csv('data/Florida.csv')
        print('Cargado desde data/Florida.csv')
    except Exception:
        df = pd.read_excel('data/Florida.xlsx', engine='openpyxl')
        print('Cargado desde data/Florida.xlsx')
except Exception:
    try:
