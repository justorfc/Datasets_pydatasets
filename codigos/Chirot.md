```python
# Código Colab para dataset: Chirot
...
try:
    try:
        df = pd.read_csv('data/Chirot.csv')
        print('Cargado desde data/Chirot.csv')
    except Exception:
        df = pd.read_excel('data/Chirot.xlsx', engine='openpyxl')
        print('Cargado desde data/Chirot.xlsx')
except Exception:
    try:
