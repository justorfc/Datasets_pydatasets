```python
# Código Colab para dataset: Sitka
...
try:
    try:
        df = pd.read_csv('data/Sitka.csv')
        print('Cargado desde data/Sitka.csv')
    except Exception:
        df = pd.read_excel('data/Sitka.xlsx', engine='openpyxl')
        print('Cargado desde data/Sitka.xlsx')
except Exception:
    try:
