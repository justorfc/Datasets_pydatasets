```python
# Código Colab para dataset: wool
...
try:
    try:
        df = pd.read_csv('data/wool.csv')
        print('Cargado desde data/wool.csv')
    except Exception:
        df = pd.read_excel('data/wool.xlsx', engine='openpyxl')
        print('Cargado desde data/wool.xlsx')
except Exception:
    try:
