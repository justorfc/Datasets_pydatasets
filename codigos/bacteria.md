```python
# Código Colab para dataset: bacteria
...
try:
    try:
        ...
        print('Cargado desde data/bacteria.csv')
    except Exception:
        df = pd.read_excel('data/bacteria.xlsx', engine='openpyxl')
        print('Cargado desde data/bacteria.xlsx')
except Exception:
    try:
