```python
# Código Colab para dataset: economics
...
try:
    try:
        ...
        print('Cargado desde data/economics.csv')
    except Exception:
        df = pd.read_excel('data/economics.xlsx', engine='openpyxl')
        print('Cargado desde data/economics.xlsx')
except Exception:
    try:
