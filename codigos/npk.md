...
try:
    try:
        df = pd.read_csv('data/npk.csv')
        print('Cargado desde data/npk.csv')
    except Exception:
        df = pd.read_excel('data/npk.xlsx', engine='openpyxl')
        print('Cargado desde data/npk.xlsx')
except Exception:
    try:
