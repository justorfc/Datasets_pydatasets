```python
# Código Colab para dataset: ruspini
...
try:
    try:
        ...
        print('Cargado desde data/ruspini.csv')
    except Exception:
        df = pd.read_excel('data/ruspini.xlsx', engine='openpyxl')
        print('Cargado desde data/ruspini.xlsx')
except Exception:
    try:
