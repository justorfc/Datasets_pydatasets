```python
# Código Colab para dataset: Labour
...
try:
    try:
        df = pd.read_csv('data/Labour.csv')
        print('Cargado desde data/Labour.csv')
    except Exception:
        df = pd.read_excel('data/Labour.xlsx', engine='openpyxl')
        print('Cargado desde data/Labour.xlsx')
except Exception:
    try:
