```python
# Código Colab para dataset: Tobacco
...
try:
    try:
        ...
        print('Cargado desde data/Tobacco.csv')
    except Exception:
        df = pd.read_excel('data/Tobacco.xlsx', engine='openpyxl')
        print('Cargado desde data/Tobacco.xlsx')
except Exception:
    try:
