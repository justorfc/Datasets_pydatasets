```python
# Código Colab para dataset: VerbAgg
...
try:
    try:
        df = pd.read_csv('data/VerbAgg.csv')
        print('Cargado desde data/VerbAgg.csv')
    except Exception:
        df = pd.read_excel('data/VerbAgg.xlsx', engine='openpyxl')
        print('Cargado desde data/VerbAgg.xlsx')
except Exception:
    try:
