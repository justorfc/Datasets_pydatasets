```python
# Código Colab para dataset: BudgetUK
...
try:
    try:
        df = pd.read_csv('data/BudgetUK.csv')
        print('Cargado desde data/BudgetUK.csv')
    except Exception:
        df = pd.read_excel('data/BudgetUK.xlsx', engine='openpyxl')
        print('Cargado desde data/BudgetUK.xlsx')
except Exception:
    try:
