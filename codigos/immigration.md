```python
# Código Colab para dataset: immigration
...
try:
    try:
        ...
        print('Cargado desde data/immigration.csv')
    except Exception:
        df = pd.read_excel('data/immigration.xlsx', engine='openpyxl')
        print('Cargado desde data/immigration.xlsx')
except Exception:
    try:
