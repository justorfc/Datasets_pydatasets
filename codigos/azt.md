...
try:
    try:
        df = pd.read_csv('data/azt.csv')
        print('Cargado desde data/azt.csv')
    except Exception:
        df = pd.read_excel('data/azt.xlsx', engine='openpyxl')
        print('Cargado desde data/azt.xlsx')
except Exception:
    try:
