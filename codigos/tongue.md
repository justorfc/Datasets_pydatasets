```python
# Código Colab para dataset: tongue
...
try:
    try:
        df = pd.read_csv('data/tongue.csv')
        print('Cargado desde data/tongue.csv')
    except Exception:
        df = pd.read_excel('data/tongue.xlsx', engine='openpyxl')
        print('Cargado desde data/tongue.xlsx')
except Exception:
    try:
