```python
# Código Colab para dataset: aircraft
...
try:
    try:
        ...
        print('Cargado desde data/aircraft.csv')
    except Exception:
        df = pd.read_excel('data/aircraft.xlsx', engine='openpyxl')
        print('Cargado desde data/aircraft.xlsx')
except Exception:
    try:
