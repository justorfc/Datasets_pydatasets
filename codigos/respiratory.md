```python
# Código Colab para dataset: respiratory
...
try:
    try:
        ...
        print('Cargado desde data/respiratory.csv')
    except Exception:
        df = pd.read_excel('data/respiratory.xlsx', engine='openpyxl')
        print('Cargado desde data/respiratory.xlsx')
except Exception:
    try:
