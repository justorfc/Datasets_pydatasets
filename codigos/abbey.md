```python
# Código Colab para dataset: abbey
...
try:
    try:
        df = pd.read_csv('data/abbey.csv')
        print('Cargado desde data/abbey.csv')
    except Exception:
        df = pd.read_excel('data/abbey.xlsx', engine='openpyxl')
        print('Cargado desde data/abbey.xlsx')
except Exception:
    try:
