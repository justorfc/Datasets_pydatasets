```python
# Código Colab para dataset: cities
...
try:
    try:
        ...
        print('Cargado desde data/cities.csv')
    except Exception:
        df = pd.read_excel('data/cities.xlsx', engine='openpyxl')
        print('Cargado desde data/cities.xlsx')
except Exception:
    try:
