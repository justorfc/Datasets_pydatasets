```python
# Código Colab para dataset: Forward
...
try:
    try:
        ...
        print('Cargado desde data/Forward.csv')
    except Exception:
        df = pd.read_excel('data/Forward.xlsx', engine='openpyxl')
        print('Cargado desde data/Forward.xlsx')
except Exception:
    try:
