```python
# Código Colab para dataset: EmplUK
...
try:
    try:
        df = pd.read_csv('data/EmplUK.csv')
        print('Cargado desde data/EmplUK.csv')
    except Exception:
        df = pd.read_excel('data/EmplUK.xlsx', engine='openpyxl')
        print('Cargado desde data/EmplUK.xlsx')
except Exception:
    try:
