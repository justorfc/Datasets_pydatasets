```python
# Código Colab para dataset: Bosco
...
try:
    try:
        df = pd.read_csv('data/Bosco.csv')
        print('Cargado desde data/Bosco.csv')
    except Exception:
        df = pd.read_excel('data/Bosco.xlsx', engine='openpyxl')
        print('Cargado desde data/Bosco.xlsx')
except Exception:
    try:
