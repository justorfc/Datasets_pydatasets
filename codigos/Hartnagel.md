```python
# Código Colab para dataset: Hartnagel
...
try:
    try:
        df = pd.read_csv('data/Hartnagel.csv')
        print('Cargado desde data/Hartnagel.csv')
    except Exception:
        df = pd.read_excel('data/Hartnagel.xlsx', engine='openpyxl')
        print('Cargado desde data/Hartnagel.xlsx')
except Exception:
    try:
