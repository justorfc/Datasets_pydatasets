...
try:
    try:
        df = pd.read_csv('data/VA.csv')
        print('Cargado desde data/VA.csv')
    except Exception:
        df = pd.read_excel('data/VA.xlsx', engine='openpyxl')
        print('Cargado desde data/VA.xlsx')
except Exception:
    try:
