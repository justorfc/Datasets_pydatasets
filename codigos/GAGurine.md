```python
# Código Colab para dataset: GAGurine
...
try:
    try:
        df = pd.read_csv('data/GAGurine.csv')
        print('Cargado desde data/GAGurine.csv')
    except Exception:
        df = pd.read_excel('data/GAGurine.xlsx', engine='openpyxl')
        print('Cargado desde data/GAGurine.xlsx')
except Exception:
    try:
