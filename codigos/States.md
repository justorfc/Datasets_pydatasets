```python
# Código Colab para dataset: States
...
try:
    try:
        ...
        print('Cargado desde data/States.csv')
    except Exception:
        df = pd.read_excel('data/States.xlsx', engine='openpyxl')
        print('Cargado desde data/States.xlsx')
except Exception:
    try:
