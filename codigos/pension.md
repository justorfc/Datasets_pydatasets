```python
# Código Colab para dataset: pension
...
try:
    try:
        ...
        print('Cargado desde data/pension.csv')
    except Exception:
        df = pd.read_excel('data/pension.xlsx', engine='openpyxl')
        print('Cargado desde data/pension.xlsx')
except Exception:
    try:
