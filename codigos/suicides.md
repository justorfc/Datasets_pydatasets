```python
# Código Colab para dataset: suicides
...
try:
    try:
        ...
        print('Cargado desde data/suicides.csv')
    except Exception:
        df = pd.read_excel('data/suicides.xlsx', engine='openpyxl')
        print('Cargado desde data/suicides.xlsx')
except Exception:
    try:
