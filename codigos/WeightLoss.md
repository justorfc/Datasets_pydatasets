```python
# Código Colab para dataset: WeightLoss
...
try:
    try:
        ...
        print('Cargado desde data/WeightLoss.csv')
    except Exception:
        df = pd.read_excel('data/WeightLoss.xlsx', engine='openpyxl')
        print('Cargado desde data/WeightLoss.xlsx')
except Exception:
    try:
