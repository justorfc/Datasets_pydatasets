```python
# Código Colab para dataset: Bfox
...
try:
    try:
        df = pd.read_csv('data/Bfox.csv')
        print('Cargado desde data/Bfox.csv')
    except Exception:
        df = pd.read_excel('data/Bfox.xlsx', engine='openpyxl')
        print('Cargado desde data/Bfox.xlsx')
except Exception:
    try:
