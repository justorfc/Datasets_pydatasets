```python
# Código Colab para dataset: Cars93
...
try:
    try:
        ...
        print('Cargado desde data/Cars93.csv')
    except Exception:
        df = pd.read_excel('data/Cars93.xlsx', engine='openpyxl')
        print('Cargado desde data/Cars93.xlsx')
except Exception:
    try:
