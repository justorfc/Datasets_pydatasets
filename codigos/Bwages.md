```python
# Código Colab para dataset: Bwages
...
try:
    try:
        df = pd.read_csv('data/Bwages.csv')
        print('Cargado desde data/Bwages.csv')
    except Exception:
        df = pd.read_excel('data/Bwages.xlsx', engine='openpyxl')
        print('Cargado desde data/Bwages.xlsx')
except Exception:
    try:
