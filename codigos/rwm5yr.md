```python
# Código Colab para dataset: rwm5yr
...
try:
    try:
        df = pd.read_csv('data/rwm5yr.csv')
        print('Cargado desde data/rwm5yr.csv')
    except Exception:
        df = pd.read_excel('data/rwm5yr.xlsx', engine='openpyxl')
        print('Cargado desde data/rwm5yr.xlsx')
except Exception:
    try:
