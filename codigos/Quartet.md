```python
# Código Colab para dataset: Quartet
...
try:
    try:
        df = pd.read_csv('data/Quartet.csv')
        print('Cargado desde data/Quartet.csv')
    except Exception:
        df = pd.read_excel('data/Quartet.xlsx', engine='openpyxl')
        print('Cargado desde data/Quartet.xlsx')
except Exception:
    try:
