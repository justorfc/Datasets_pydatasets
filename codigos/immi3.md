```python
# Código Colab para dataset: immi3
...
try:
    try:
        df = pd.read_csv('data/immi3.csv')
        print('Cargado desde data/immi3.csv')
    except Exception:
        df = pd.read_excel('data/immi3.xlsx', engine='openpyxl')
        print('Cargado desde data/immi3.xlsx')
except Exception:
    try:
