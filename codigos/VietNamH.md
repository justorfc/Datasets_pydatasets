```python
# Código Colab para dataset: VietNamH
...
try:
    try:
        df = pd.read_csv('data/VietNamH.csv')
        print('Cargado desde data/VietNamH.csv')
    except Exception:
        df = pd.read_excel('data/VietNamH.xlsx', engine='openpyxl')
        print('Cargado desde data/VietNamH.xlsx')
except Exception:
    try:
