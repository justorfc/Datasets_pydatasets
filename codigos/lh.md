...
try:
    try:
        df = pd.read_csv('data/lh.csv')
        print('Cargado desde data/lh.csv')
    except Exception:
        df = pd.read_excel('data/lh.xlsx', engine='openpyxl')
        print('Cargado desde data/lh.xlsx')
except Exception:
    try:
