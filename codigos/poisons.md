```python
# Código Colab para dataset: poisons
...
try:
    try:
        df = pd.read_csv('data/poisons.csv')
        print('Cargado desde data/poisons.csv')
    except Exception:
        df = pd.read_excel('data/poisons.xlsx', engine='openpyxl')
        print('Cargado desde data/poisons.xlsx')
except Exception:
    try:
