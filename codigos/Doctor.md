```python
# Código Colab para dataset: Doctor
...
try:
    try:
        ...
        print('Cargado desde data/Doctor.csv')
    except Exception:
        df = pd.read_excel('data/Doctor.xlsx', engine='openpyxl')
        print('Cargado desde data/Doctor.xlsx')
except Exception:
    try:
