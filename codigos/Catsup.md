```python
# Código Colab para dataset: Catsup
...
try:
    try:
        df = pd.read_csv('data/Catsup.csv')
        print('Cargado desde data/Catsup.csv')
    except Exception:
        df = pd.read_excel('data/Catsup.xlsx', engine='openpyxl')
        print('Cargado desde data/Catsup.xlsx')
except Exception:
    try:
