```python
# Código Colab para dataset: Ericksen
...
try:
    try:
        df = pd.read_csv('data/Ericksen.csv')
        print('Cargado desde data/Ericksen.csv')
    except Exception:
        df = pd.read_excel('data/Ericksen.xlsx', engine='openpyxl')
        print('Cargado desde data/Ericksen.xlsx')
except Exception:
    try:
