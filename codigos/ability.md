```python
# Código Colab para dataset: ability
...
try:
    try:
        ...
        print('Cargado desde data/ability.csv')
    except Exception:
        df = pd.read_excel('data/ability.xlsx', engine='openpyxl')
        print('Cargado desde data/ability.xlsx')
except Exception:
    try:
