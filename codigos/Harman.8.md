```python
# Código Colab para dataset: Harman.8
...
try:
    try:
        df = pd.read_csv('data/Harman.8.csv')
        print('Cargado desde data/Harman.8.csv')
    except Exception:
        df = pd.read_excel('data/Harman.8.xlsx', engine='openpyxl')
        print('Cargado desde data/Harman.8.xlsx')
except Exception:
    try:
