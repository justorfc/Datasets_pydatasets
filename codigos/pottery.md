```python
# Código Colab para dataset: pottery
...
try:
    try:
        df = pd.read_csv('data/pottery.csv')
        print('Cargado desde data/pottery.csv')
    except Exception:
        df = pd.read_excel('data/pottery.xlsx', engine='openpyxl')
        print('Cargado desde data/pottery.xlsx')
except Exception:
    try:
