```python
# Código Colab para dataset: Insurance
...
try:
    try:
        ...
        print('Cargado desde data/Insurance.csv')
    except Exception:
        df = pd.read_excel('data/Insurance.xlsx', engine='openpyxl')
        print('Cargado desde data/Insurance.xlsx')
except Exception:
    try:
