```python
# Código Colab para dataset: islands
...
try:
    try:
        df = pd.read_csv('data/islands.csv')
        print('Cargado desde data/islands.csv')
    except Exception:
        df = pd.read_excel('data/islands.xlsx', engine='openpyxl')
        print('Cargado desde data/islands.xlsx')
except Exception:
    try:
