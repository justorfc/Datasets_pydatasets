```python
# Código Colab para dataset: Nightingale
...
try:
    try:
        ...
        print('Cargado desde data/Nightingale.csv')
    except Exception:
        df = pd.read_excel('data/Nightingale.xlsx', engine='openpyxl')
        print('Cargado desde data/Nightingale.xlsx')
except Exception:
    try:
