```python
# Código Colab para dataset: neuro
...
try:
    try:
        df = pd.read_csv('data/neuro.csv')
        print('Cargado desde data/neuro.csv')
    except Exception:
        df = pd.read_excel('data/neuro.xlsx', engine='openpyxl')
        print('Cargado desde data/neuro.xlsx')
except Exception:
    try:
