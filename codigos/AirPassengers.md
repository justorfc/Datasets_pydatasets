```python
# Código Colab para dataset: AirPassengers
...
try:
    try:
        ...
        print('Cargado desde data/AirPassengers.csv')
    except Exception:
        df = pd.read_excel('data/AirPassengers.xlsx', engine='openpyxl')
        print('Cargado desde data/AirPassengers.xlsx')
except Exception:
    try:
