```python
# Código Colab para dataset: MedExp
...
try:
    try:
        df = pd.read_csv('data/MedExp.csv')
        print('Cargado desde data/MedExp.csv')
    except Exception:
        df = pd.read_excel('data/MedExp.xlsx', engine='openpyxl')
        print('Cargado desde data/MedExp.xlsx')
except Exception:
    try:
