```python
# Código Colab para dataset: Journals
...
try:
    try:
        ...
        print('Cargado desde data/Journals.csv')
    except Exception:
        df = pd.read_excel('data/Journals.xlsx', engine='openpyxl')
        print('Cargado desde data/Journals.xlsx')
except Exception:
    try:
