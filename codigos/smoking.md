```python
# Código Colab para dataset: smoking
...
try:
    try:
        ...
        print('Cargado desde data/smoking.csv')
    except Exception:
        df = pd.read_excel('data/smoking.xlsx', engine='openpyxl')
        print('Cargado desde data/smoking.xlsx')
except Exception:
    try:
