```python
# Código Colab para dataset: Arbuthnot
...
try:
    try:
        df = pd.read_csv('data/Arbuthnot.csv')
        print('Cargado desde data/Arbuthnot.csv')
    except Exception:
        df = pd.read_excel('data/Arbuthnot.xlsx', engine='openpyxl')
        print('Cargado desde data/Arbuthnot.xlsx')
except Exception:
    try:
