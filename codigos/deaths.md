```python
# Código Colab para dataset: deaths
...
try:
    try:
        ...
        print('Cargado desde data/deaths.csv')
    except Exception:
        df = pd.read_excel('data/deaths.xlsx', engine='openpyxl')
        print('Cargado desde data/deaths.xlsx')
except Exception:
    try:
