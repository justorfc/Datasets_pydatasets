```python
# Código Colab para dataset: biopsy
...
try:
    try:
        df = pd.read_csv('data/biopsy.csv')
        print('Cargado desde data/biopsy.csv')
    except Exception:
        df = pd.read_excel('data/biopsy.xlsx', engine='openpyxl')
        print('Cargado desde data/biopsy.xlsx')
except Exception:
    try:
