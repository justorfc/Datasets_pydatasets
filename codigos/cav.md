...
try:
    try:
        df = pd.read_csv('data/cav.csv')
        print('Cargado desde data/cav.csv')
    except Exception:
        df = pd.read_excel('data/cav.xlsx', engine='openpyxl')
        print('Cargado desde data/cav.xlsx')
except Exception:
    try:
