```python
# Código Colab para dataset: Reise
...
try:
    try:
        df = pd.read_csv('data/Reise.csv')
        print('Cargado desde data/Reise.csv')
    except Exception:
        df = pd.read_excel('data/Reise.xlsx', engine='openpyxl')
        print('Cargado desde data/Reise.xlsx')
except Exception:
    try:
