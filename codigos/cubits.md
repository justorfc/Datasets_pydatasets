```python
# Código Colab para dataset: cubits
...
try:
    try:
        df = pd.read_csv('data/cubits.csv')
        print('Cargado desde data/cubits.csv')
    except Exception:
        df = pd.read_excel('data/cubits.xlsx', engine='openpyxl')
        print('Cargado desde data/cubits.xlsx')
except Exception:
    try:
