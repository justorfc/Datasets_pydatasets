```python
# Código Colab para dataset: sunspots
...
try:
    try:
        ...
        print('Cargado desde data/sunspots.csv')
    except Exception:
        df = pd.read_excel('data/sunspots.xlsx', engine='openpyxl')
        print('Cargado desde data/sunspots.xlsx')
except Exception:
    try:
