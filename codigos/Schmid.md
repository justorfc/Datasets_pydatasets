```python
# Código Colab para dataset: Schmid
...
try:
    try:
        df = pd.read_csv('data/Schmid.csv')
        print('Cargado desde data/Schmid.csv')
    except Exception:
        df = pd.read_excel('data/Schmid.xlsx', engine='openpyxl')
        print('Cargado desde data/Schmid.xlsx')
except Exception:
    try:
