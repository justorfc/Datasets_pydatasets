```python
# Código Colab para dataset: mexico
...
try:
    try:
        df = pd.read_csv('data/mexico.csv')
        print('Cargado desde data/mexico.csv')
    except Exception:
        df = pd.read_excel('data/mexico.xlsx', engine='openpyxl')
        print('Cargado desde data/mexico.xlsx')
except Exception:
    try:
