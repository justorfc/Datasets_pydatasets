```python
# Código Colab para dataset: spruce
...
try:
    try:
        df = pd.read_csv('data/spruce.csv')
        print('Cargado desde data/spruce.csv')
    except Exception:
        df = pd.read_excel('data/spruce.xlsx', engine='openpyxl')
        print('Cargado desde data/spruce.xlsx')
except Exception:
    try:
