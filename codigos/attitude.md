```python
# Código Colab para dataset: attitude
...
try:
    try:
        ...
        print('Cargado desde data/attitude.csv')
    except Exception:
        df = pd.read_excel('data/attitude.xlsx', engine='openpyxl')
        print('Cargado desde data/attitude.xlsx')
except Exception:
    try:
