```python
# Código Colab para dataset: survival
...
try:
    try:
        ...
        print('Cargado desde data/survival.csv')
    except Exception:
        df = pd.read_excel('data/survival.xlsx', engine='openpyxl')
        print('Cargado desde data/survival.xlsx')
except Exception:
    try:
