```python
# Código Colab para dataset: Bollen
...
try:
    try:
        df = pd.read_csv('data/Bollen.csv')
        print('Cargado desde data/Bollen.csv')
    except Exception:
        df = pd.read_excel('data/Bollen.xlsx', engine='openpyxl')
        print('Cargado desde data/Bollen.xlsx')
except Exception:
    try:
