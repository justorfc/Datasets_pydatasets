```python
# Código Colab para dataset: lbwgrp
...
try:
    try:
        df = pd.read_csv('data/lbwgrp.csv')
        print('Cargado desde data/lbwgrp.csv')
    except Exception:
        df = pd.read_excel('data/lbwgrp.xlsx', engine='openpyxl')
        print('Cargado desde data/lbwgrp.xlsx')
except Exception:
    try:
