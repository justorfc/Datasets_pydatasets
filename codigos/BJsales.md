```python
# Código Colab para dataset: BJsales
...
try:
    try:
        df = pd.read_csv('data/BJsales.csv')
        print('Cargado desde data/BJsales.csv')
    except Exception:
        df = pd.read_excel('data/BJsales.xlsx', engine='openpyxl')
        print('Cargado desde data/BJsales.xlsx')
except Exception:
    try:
