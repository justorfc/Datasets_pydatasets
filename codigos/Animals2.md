```python
# Código Colab para dataset: Animals2
...
try:
    try:
        ...
        print('Cargado desde data/Animals2.csv')
    except Exception:
        df = pd.read_excel('data/Animals2.xlsx', engine='openpyxl')
        print('Cargado desde data/Animals2.xlsx')
except Exception:
    try:
