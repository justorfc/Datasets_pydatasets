```python
# Código Colab para dataset: Rubber
...
try:
    try:
        df = pd.read_csv('data/Rubber.csv')
        print('Cargado desde data/Rubber.csv')
    except Exception:
        df = pd.read_excel('data/Rubber.xlsx', engine='openpyxl')
        print('Cargado desde data/Rubber.xlsx')
except Exception:
    try:
