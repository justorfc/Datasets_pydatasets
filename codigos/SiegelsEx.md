```python
# Código Colab para dataset: SiegelsEx
...
try:
    try:
        df = pd.read_csv('data/SiegelsEx.csv')
        print('Cargado desde data/SiegelsEx.csv')
    except Exception:
        df = pd.read_excel('data/SiegelsEx.xlsx', engine='openpyxl')
        print('Cargado desde data/SiegelsEx.xlsx')
except Exception:
    try:
