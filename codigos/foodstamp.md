```python
# Código Colab para dataset: foodstamp
...
try:
    try:
        df = pd.read_csv('data/foodstamp.csv')
        print('Cargado desde data/foodstamp.csv')
    except Exception:
        df = pd.read_excel('data/foodstamp.xlsx', engine='openpyxl')
        print('Cargado desde data/foodstamp.xlsx')
except Exception:
    try:
