```python
# Código Colab para dataset: Womenlf
...
try:
    try:
        ...
        print('Cargado desde data/Womenlf.csv')
    except Exception:
        df = pd.read_excel('data/Womenlf.xlsx', engine='openpyxl')
        print('Cargado desde data/Womenlf.xlsx')
except Exception:
    try:
