```python
# Código Colab para dataset: StrikeNb
...
try:
    try:
        df = pd.read_csv('data/StrikeNb.csv')
        print('Cargado desde data/StrikeNb.csv')
    except Exception:
        df = pd.read_excel('data/StrikeNb.xlsx', engine='openpyxl')
        print('Cargado desde data/StrikeNb.xlsx')
except Exception:
    try:
