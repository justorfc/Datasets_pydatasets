```python
# Código Colab para dataset: coalition
...
try:
    try:
        df = pd.read_csv('data/coalition.csv')
        print('Cargado desde data/coalition.csv')
    except Exception:
        df = pd.read_excel('data/coalition.xlsx', engine='openpyxl')
        print('Cargado desde data/coalition.xlsx')
except Exception:
    try:
