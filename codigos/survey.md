```python
# Código Colab para dataset: survey
...
try:
    try:
        ...
        print('Cargado desde data/survey.csv')
    except Exception:
        df = pd.read_excel('data/survey.xlsx', engine='openpyxl')
        print('Cargado desde data/survey.xlsx')
except Exception:
    try:
