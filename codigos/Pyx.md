...
try:
    try:
        df = pd.read_csv('data/Pyx.csv')
        print('Cargado desde data/Pyx.csv')
    except Exception:
        df = pd.read_excel('data/Pyx.xlsx', engine='openpyxl')
        print('Cargado desde data/Pyx.xlsx')
except Exception:
    try:
