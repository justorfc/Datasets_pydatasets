```python
# Código Colab para dataset: Schooling
...
try:
    try:
        ...
        print('Cargado desde data/Schooling.csv')
    except Exception:
        df = pd.read_excel('data/Schooling.xlsx', engine='openpyxl')
        print('Cargado desde data/Schooling.xlsx')
except Exception:
    try:
