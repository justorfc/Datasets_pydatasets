```python
# Código Colab para dataset: free1
...
try:
    try:
        df = pd.read_csv('data/free1.csv')
        print('Cargado desde data/free1.csv')
    except Exception:
        df = pd.read_excel('data/free1.xlsx', engine='openpyxl')
        print('Cargado desde data/free1.xlsx')
except Exception:
    try:
