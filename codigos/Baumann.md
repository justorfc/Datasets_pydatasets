```python
# Código Colab para dataset: Baumann
...
try:
    try:
        df = pd.read_csv('data/Baumann.csv')
        print('Cargado desde data/Baumann.csv')
    except Exception:
        df = pd.read_excel('data/Baumann.xlsx', engine='openpyxl')
        print('Cargado desde data/Baumann.xlsx')
except Exception:
    try:
