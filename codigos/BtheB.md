```python
# Código Colab para dataset: BtheB
...
try:
    try:
        df = pd.read_csv('data/BtheB.csv')
        print('Cargado desde data/BtheB.csv')
    except Exception:
        df = pd.read_excel('data/BtheB.xlsx', engine='openpyxl')
        print('Cargado desde data/BtheB.xlsx')
except Exception:
    try:
