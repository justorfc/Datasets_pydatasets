```python
# Código Colab para dataset: mhtdata
...
try:
    try:
        df = pd.read_csv('data/mhtdata.csv')
        print('Cargado desde data/mhtdata.csv')
    except Exception:
        df = pd.read_excel('data/mhtdata.xlsx', engine='openpyxl')
        print('Cargado desde data/mhtdata.xlsx')
except Exception:
    try:
