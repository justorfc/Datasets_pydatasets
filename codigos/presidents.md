```python
# Código Colab para dataset: presidents
...
try:
    try:
        ...
        print('Cargado desde data/presidents.csv')
    except Exception:
        df = pd.read_excel('data/presidents.xlsx', engine='openpyxl')
        print('Cargado desde data/presidents.xlsx')
except Exception:
    try:
