```python
# Código Colab para dataset: Benefits
...
try:
    try:
        ...
        print('Cargado desde data/Benefits.csv')
    except Exception:
        df = pd.read_excel('data/Benefits.xlsx', engine='openpyxl')
        print('Cargado desde data/Benefits.xlsx')
except Exception:
    try:
