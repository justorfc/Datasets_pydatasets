```python
# Código Colab para dataset: animals
...
try:
    try:
        ...
        print('Cargado desde data/animals.csv')
    except Exception:
        df = pd.read_excel('data/animals.xlsx', engine='openpyxl')
        print('Cargado desde data/animals.xlsx')
except Exception:
    try:
