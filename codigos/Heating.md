```python
# Código Colab para dataset: Heating
...
try:
    try:
        ...
        print('Cargado desde data/Heating.csv')
    except Exception:
        df = pd.read_excel('data/Heating.xlsx', engine='openpyxl')
        print('Cargado desde data/Heating.xlsx')
except Exception:
    try:
