```python
# Código Colab para dataset: Hospital
...
try:
    try:
        ...
        print('Cargado desde data/Hospital.csv')
    except Exception:
        df = pd.read_excel('data/Hospital.xlsx', engine='openpyxl')
        print('Cargado desde data/Hospital.xlsx')
except Exception:
    try:
