...
try:
    try:
        df = pd.read_csv('data/GHQ.csv')
        print('Cargado desde data/GHQ.csv')
    except Exception:
        df = pd.read_excel('data/GHQ.xlsx', engine='openpyxl')
        print('Cargado desde data/GHQ.xlsx')
except Exception:
    try:
