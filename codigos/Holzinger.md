```python
# Código Colab para dataset: Holzinger
...
try:
    try:
        df = pd.read_csv('data/Holzinger.csv')
        print('Cargado desde data/Holzinger.csv')
    except Exception:
        df = pd.read_excel('data/Holzinger.xlsx', engine='openpyxl')
        print('Cargado desde data/Holzinger.xlsx')
except Exception:
    try:
