```python
# Código Colab para dataset: sat.act
...
try:
    try:
        df = pd.read_csv('data/sat.act.csv')
        print('Cargado desde data/sat.act.csv')
    except Exception:
        df = pd.read_excel('data/sat.act.xlsx', engine='openpyxl')
        print('Cargado desde data/sat.act.xlsx')
except Exception:
    try:
