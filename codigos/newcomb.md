```python
# Código Colab para dataset: newcomb
...
try:
    try:
        df = pd.read_csv('data/newcomb.csv')
        print('Cargado desde data/newcomb.csv')
    except Exception:
        df = pd.read_excel('data/newcomb.xlsx', engine='openpyxl')
        print('Cargado desde data/newcomb.xlsx')
except Exception:
    try:
