```python
# Código Colab para dataset: dietox
...
try:
    try:
        df = pd.read_csv('data/dietox.csv')
        print('Cargado desde data/dietox.csv')
    except Exception:
        df = pd.read_excel('data/dietox.xlsx', engine='openpyxl')
        print('Cargado desde data/dietox.xlsx')
except Exception:
    try:
