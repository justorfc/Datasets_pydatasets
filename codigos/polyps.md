```python
# Código Colab para dataset: polyps
...
try:
    try:
        df = pd.read_csv('data/polyps.csv')
        print('Cargado desde data/polyps.csv')
    except Exception:
        df = pd.read_excel('data/polyps.xlsx', engine='openpyxl')
        print('Cargado desde data/polyps.xlsx')
except Exception:
    try:
