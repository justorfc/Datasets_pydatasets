```python
# Código Colab para dataset: Employment
...
try:
    try:
        ...
        print('Cargado desde data/Employment.csv')
    except Exception:
        df = pd.read_excel('data/Employment.xlsx', engine='openpyxl')
        print('Cargado desde data/Employment.xlsx')
except Exception:
    try:
