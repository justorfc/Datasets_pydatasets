```python
# Código Colab para dataset: RepVict
...
try:
    try:
        df = pd.read_csv('data/RepVict.csv')
        print('Cargado desde data/RepVict.csv')
    except Exception:
        df = pd.read_excel('data/RepVict.xlsx', engine='openpyxl')
        print('Cargado desde data/RepVict.xlsx')
except Exception:
    try:
