```python
# Código Colab para dataset: immi1
...
try:
    try:
        df = pd.read_csv('data/immi1.csv')
        print('Cargado desde data/immi1.csv')
    except Exception:
        df = pd.read_excel('data/immi1.xlsx', engine='openpyxl')
        print('Cargado desde data/immi1.xlsx')
except Exception:
    try:
