```python
# Código Colab para dataset: Pima.te
...
try:
    try:
        df = pd.read_csv('data/Pima.te.csv')
        print('Cargado desde data/Pima.te.csv')
    except Exception:
        df = pd.read_excel('data/Pima.te.xlsx', engine='openpyxl')
        print('Cargado desde data/Pima.te.xlsx')
except Exception:
    try:
