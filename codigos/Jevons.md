```python
# Código Colab para dataset: Jevons
...
try:
    try:
        df = pd.read_csv('data/Jevons.csv')
        print('Cargado desde data/Jevons.csv')
    except Exception:
        df = pd.read_excel('data/Jevons.xlsx', engine='openpyxl')
        print('Cargado desde data/Jevons.xlsx')
except Exception:
    try:
