```python
# Código Colab para dataset: SexualFun
...
try:
    try:
        df = pd.read_csv('data/SexualFun.csv')
        print('Cargado desde data/SexualFun.csv')
    except Exception:
        df = pd.read_excel('data/SexualFun.xlsx', engine='openpyxl')
        print('Cargado desde data/SexualFun.xlsx')
except Exception:
    try:
