```python
# Código Colab para dataset: urine
...
try:
    try:
        df = pd.read_csv('data/urine.csv')
        print('Cargado desde data/urine.csv')
    except Exception:
        df = pd.read_excel('data/urine.xlsx', engine='openpyxl')
        print('Cargado desde data/urine.xlsx')
except Exception:
    try:
