```python
# Código Colab para dataset: condroz
...
try:
    try:
        df = pd.read_csv('data/condroz.csv')
        print('Cargado desde data/condroz.csv')
    except Exception:
        df = pd.read_excel('data/condroz.xlsx', engine='openpyxl')
        print('Cargado desde data/condroz.xlsx')
except Exception:
    try:
