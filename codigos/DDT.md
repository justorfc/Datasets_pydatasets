...
try:
    try:
        df = pd.read_csv('data/DDT.csv')
        print('Cargado desde data/DDT.csv')
    except Exception:
        df = pd.read_excel('data/DDT.xlsx', engine='openpyxl')
        print('Cargado desde data/DDT.xlsx')
except Exception:
    try:
