```python
# Código Colab para dataset: Pima.tr
...
try:
    try:
        ...
        print('Cargado desde data/Pima.tr.csv')
    except Exception:
        df = pd.read_excel('data/Pima.tr.xlsx', engine='openpyxl')
        print('Cargado desde data/Pima.tr.xlsx')
except Exception:
    try:
