```python
# Código Colab para dataset: airmiles
...
try:
    try:
        ...
        print('Cargado desde data/airmiles.csv')
    except Exception:
        df = pd.read_excel('data/airmiles.xlsx', engine='openpyxl')
        print('Cargado desde data/airmiles.xlsx')
except Exception:
    try:
