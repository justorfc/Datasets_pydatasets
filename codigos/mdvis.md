```python
# Código Colab para dataset: mdvis
...
try:
    try:
        df = pd.read_csv('data/mdvis.csv')
        print('Cargado desde data/mdvis.csv')
    except Exception:
        df = pd.read_excel('data/mdvis.xlsx', engine='openpyxl')
        print('Cargado desde data/mdvis.xlsx')
except Exception:
    try:
