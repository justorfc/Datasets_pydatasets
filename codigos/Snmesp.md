```python
# Código Colab para dataset: Snmesp
...
try:
    try:
        df = pd.read_csv('data/Snmesp.csv')
        print('Cargado desde data/Snmesp.csv')
    except Exception:
        df = pd.read_excel('data/Snmesp.xlsx', engine='openpyxl')
        print('Cargado desde data/Snmesp.xlsx')
except Exception:
    try:
