```python
# Código Colab para dataset: salinity
...
try:
    try:
        df = pd.read_csv('data/salinity.csv')
        print('Cargado desde data/salinity.csv')
    except Exception:
        df = pd.read_excel('data/salinity.xlsx', engine='openpyxl')
        print('Cargado desde data/salinity.xlsx')
except Exception:
    try:
