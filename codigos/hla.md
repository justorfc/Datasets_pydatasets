...
try:
    try:
        df = pd.read_csv('data/hla.csv')
        print('Cargado desde data/hla.csv')
    except Exception:
        df = pd.read_excel('data/hla.xlsx', engine='openpyxl')
        print('Cargado desde data/hla.xlsx')
except Exception:
    try:
