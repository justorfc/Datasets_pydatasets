```python
# Código Colab para dataset: alloauto
...
try:
    try:
        df = pd.read_csv('data/alloauto.csv')
        print('Cargado desde data/alloauto.csv')
    except Exception:
        df = pd.read_excel('data/alloauto.xlsx', engine='openpyxl')
        print('Cargado desde data/alloauto.xlsx')
except Exception:
    try:
