```python
# Código Colab para dataset: aids
...
try:
    try:
        df = pd.read_csv('data/aids.csv')
        print('Cargado desde data/aids.csv')
    except Exception:
        df = pd.read_excel('data/aids.xlsx', engine='openpyxl')
        print('Cargado desde data/aids.xlsx')
except Exception:
    try:
