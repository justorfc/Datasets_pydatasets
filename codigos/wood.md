```python
# Código Colab para dataset: wood
...
try:
    try:
        df = pd.read_csv('data/wood.csv')
        print('Cargado desde data/wood.csv')
    except Exception:
        df = pd.read_excel('data/wood.xlsx', engine='openpyxl')
        print('Cargado desde data/wood.xlsx')
except Exception:
    try:
