```python
# Código Colab para dataset: SumHes
...
try:
    try:
        df = pd.read_csv('data/SumHes.csv')
        print('Cargado desde data/SumHes.csv')
    except Exception:
        df = pd.read_excel('data/SumHes.xlsx', engine='openpyxl')
        print('Cargado desde data/SumHes.xlsx')
except Exception:
    try:
