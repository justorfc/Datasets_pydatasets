```python
# Código Colab para dataset: ToothGrowth
...
try:
    try:
        ...
        print('Cargado desde data/ToothGrowth.csv')
    except Exception:
        df = pd.read_excel('data/ToothGrowth.xlsx', engine='openpyxl')
        print('Cargado desde data/ToothGrowth.xlsx')
except Exception:
    try:
