...
try:
    try:
        df = pd.read_csv('data/cgd.csv')
        print('Cargado desde data/cgd.csv')
    except Exception:
        df = pd.read_excel('data/cgd.xlsx', engine='openpyxl')
        print('Cargado desde data/cgd.xlsx')
except Exception:
    try:
