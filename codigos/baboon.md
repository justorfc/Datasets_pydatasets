```python
# Código Colab para dataset: baboon
...
try:
    try:
        df = pd.read_csv('data/baboon.csv')
        print('Cargado desde data/baboon.csv')
    except Exception:
        df = pd.read_excel('data/baboon.xlsx', engine='openpyxl')
        print('Cargado desde data/baboon.xlsx')
except Exception:
    try:
