```python
# Código Colab para dataset: whiteside
...
try:
    try:
        df = pd.read_csv('data/whiteside.csv')
        print('Cargado desde data/whiteside.csv')
    except Exception:
        df = pd.read_excel('data/whiteside.xlsx', engine='openpyxl')
        print('Cargado desde data/whiteside.xlsx')
except Exception:
    try:
