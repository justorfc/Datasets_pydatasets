```python
# Código Colab para dataset: mgus
...
try:
    try:
        df = pd.read_csv('data/mgus.csv')
        print('Cargado desde data/mgus.csv')
    except Exception:
        df = pd.read_excel('data/mgus.xlsx', engine='openpyxl')
        print('Cargado desde data/mgus.xlsx')
except Exception:
    try:
