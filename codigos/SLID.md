```python
# Código Colab para dataset: SLID
...
try:
    try:
        df = pd.read_csv('data/SLID.csv')
        print('Cargado desde data/SLID.csv')
    except Exception:
        df = pd.read_excel('data/SLID.xlsx', engine='openpyxl')
        print('Cargado desde data/SLID.xlsx')
except Exception:
    try:
