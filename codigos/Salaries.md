```python
# Código Colab para dataset: Salaries
...
try:
    try:
        ...
        print('Cargado desde data/Salaries.csv')
    except Exception:
        df = pd.read_excel('data/Salaries.xlsx', engine='openpyxl')
        print('Cargado desde data/Salaries.xlsx')
except Exception:
    try:
