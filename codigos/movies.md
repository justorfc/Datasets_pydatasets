```python
# Código Colab para dataset: movies
...
try:
    try:
        ...
        print('Cargado desde data/movies.csv')
    except Exception:
        df = pd.read_excel('data/movies.xlsx', engine='openpyxl')
        print('Cargado desde data/movies.xlsx')
except Exception:
    try:
