```python
# Código Colab para dataset: Pastes
...
try:
    try:
        df = pd.read_csv('data/Pastes.csv')
        print('Cargado desde data/Pastes.csv')
    except Exception:
        df = pd.read_excel('data/Pastes.xlsx', engine='openpyxl')
        print('Cargado desde data/Pastes.xlsx')
except Exception:
    try:
