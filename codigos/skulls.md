```python
# Código Colab para dataset: skulls
...
try:
    try:
        df = pd.read_csv('data/skulls.csv')
        print('Cargado desde data/skulls.csv')
    except Exception:
        df = pd.read_excel('data/skulls.xlsx', engine='openpyxl')
        print('Cargado desde data/skulls.xlsx')
except Exception:
    try:
