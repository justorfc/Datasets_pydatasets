```python
# Código Colab para dataset: Computers
...
try:
    try:
        ...
        print('Cargado desde data/Computers.csv')
    except Exception:
        df = pd.read_excel('data/Computers.xlsx', engine='openpyxl')
        print('Cargado desde data/Computers.xlsx')
except Exception:
    try:
