```python
# Código Colab para dataset: Wages1
...
try:
    try:
        ...
        print('Cargado desde data/Wages1.csv')
    except Exception:
        df = pd.read_excel('data/Wages1.xlsx', engine='openpyxl')
        print('Cargado desde data/Wages1.xlsx')
except Exception:
    try:
