```python
# Código Colab para dataset: lactic
...
try:
    try:
        df = pd.read_csv('data/lactic.csv')
        print('Cargado desde data/lactic.csv')
    except Exception:
        df = pd.read_excel('data/lactic.xlsx', engine='openpyxl')
        print('Cargado desde data/lactic.xlsx')
except Exception:
    try:
