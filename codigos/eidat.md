```python
# Código Colab para dataset: eidat
...
try:
    try:
        df = pd.read_csv('data/eidat.csv')
        print('Cargado desde data/eidat.csv')
    except Exception:
        df = pd.read_excel('data/eidat.xlsx', engine='openpyxl')
        print('Cargado desde data/eidat.xlsx')
except Exception:
    try:
