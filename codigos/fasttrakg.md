```python
# Código Colab para dataset: fasttrakg
...
try:
    try:
        df = pd.read_csv('data/fasttrakg.csv')
        print('Cargado desde data/fasttrakg.csv')
    except Exception:
        df = pd.read_excel('data/fasttrakg.xlsx', engine='openpyxl')
        print('Cargado desde data/fasttrakg.xlsx')
except Exception:
    try:
