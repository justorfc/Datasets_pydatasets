```python
# Código Colab para dataset: drivers
...
try:
    try:
        ...
        print('Cargado desde data/drivers.csv')
    except Exception:
        df = pd.read_excel('data/drivers.xlsx', engine='openpyxl')
        print('Cargado desde data/drivers.xlsx')
except Exception:
    try:
