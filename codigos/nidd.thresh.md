```python
# Código Colab para dataset: nidd.thresh
...
try:
    try:
        ...
        print('Cargado desde data/nidd.thresh.csv')
    except Exception:
        df = pd.read_excel('data/nidd.thresh.xlsx', engine='openpyxl')
        print('Cargado desde data/nidd.thresh.xlsx')
except Exception:
    try:
