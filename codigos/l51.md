...
try:
    try:
        df = pd.read_csv('data/l51.csv')
        print('Cargado desde data/l51.csv')
    except Exception:
        df = pd.read_excel('data/l51.xlsx', engine='openpyxl')
        print('Cargado desde data/l51.xlsx')
except Exception:
    try:
