...
try:
    try:
        df = pd.read_csv('data/cd4.csv')
        print('Cargado desde data/cd4.csv')
    except Exception:
        df = pd.read_excel('data/cd4.xlsx', engine='openpyxl')
        print('Cargado desde data/cd4.xlsx')
except Exception:
    try:
