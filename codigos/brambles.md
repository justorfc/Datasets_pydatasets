```python
# Código Colab para dataset: brambles
...
try:
    try:
        df = pd.read_csv('data/brambles.csv')
        print('Cargado desde data/brambles.csv')
    except Exception:
        df = pd.read_excel('data/brambles.xlsx', engine='openpyxl')
        print('Cargado desde data/brambles.xlsx')
except Exception:
    try:
