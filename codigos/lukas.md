```python
# Código Colab para dataset: lukas
...
try:
    try:
        df = pd.read_csv('data/lukas.csv')
        print('Cargado desde data/lukas.csv')
    except Exception:
        df = pd.read_excel('data/lukas.xlsx', engine='openpyxl')
        print('Cargado desde data/lukas.xlsx')
except Exception:
    try:
