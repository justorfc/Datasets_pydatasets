```python
# Código Colab para dataset: Harman.5
...
try:
    try:
        df = pd.read_csv('data/Harman.5.csv')
        print('Cargado desde data/Harman.5.csv')
    except Exception:
        df = pd.read_excel('data/Harman.5.xlsx', engine='openpyxl')
        print('Cargado desde data/Harman.5.xlsx')
except Exception:
    try:
