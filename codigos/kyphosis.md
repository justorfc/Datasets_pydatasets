```python
# Código Colab para dataset: kyphosis
...
try:
    try:
        ...
        print('Cargado desde data/kyphosis.csv')
    except Exception:
        df = pd.read_excel('data/kyphosis.xlsx', engine='openpyxl')
        print('Cargado desde data/kyphosis.xlsx')
except Exception:
    try:
