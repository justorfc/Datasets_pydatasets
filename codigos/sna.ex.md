```python
# Código Colab para dataset: sna.ex
...
try:
    try:
        df = pd.read_csv('data/sna.ex.csv')
        print('Cargado desde data/sna.ex.csv')
    except Exception:
        df = pd.read_excel('data/sna.ex.xlsx', engine='openpyxl')
        print('Cargado desde data/sna.ex.xlsx')
except Exception:
    try:
