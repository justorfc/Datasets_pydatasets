```python
# Código Colab para dataset: MunExp
...
try:
    try:
        df = pd.read_csv('data/MunExp.csv')
        print('Cargado desde data/MunExp.csv')
    except Exception:
        df = pd.read_excel('data/MunExp.xlsx', engine='openpyxl')
        print('Cargado desde data/MunExp.xlsx')
except Exception:
    try:
