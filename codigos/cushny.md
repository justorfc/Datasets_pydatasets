```python
# Código Colab para dataset: cushny
...
try:
    try:
        df = pd.read_csv('data/cushny.csv')
        print('Cargado desde data/cushny.csv')
    except Exception:
        df = pd.read_excel('data/cushny.xlsx', engine='openpyxl')
        print('Cargado desde data/cushny.xlsx')
except Exception:
    try:
