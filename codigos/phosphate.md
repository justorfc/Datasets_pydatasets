```python
# Código Colab para dataset: phosphate
...
try:
    try:
        df = pd.read_csv('data/phosphate.csv')
        print('Cargado desde data/phosphate.csv')
    except Exception:
        df = pd.read_excel('data/phosphate.xlsx', engine='openpyxl')
        print('Cargado desde data/phosphate.xlsx')
except Exception:
    try:
