```python
# Código Colab para dataset: chorSub
...
try:
    try:
        df = pd.read_csv('data/chorSub.csv')
        print('Cargado desde data/chorSub.csv')
    except Exception:
        df = pd.read_excel('data/chorSub.xlsx', engine='openpyxl')
        print('Cargado desde data/chorSub.xlsx')
except Exception:
    try:
