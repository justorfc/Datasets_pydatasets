```python
# Código Colab para dataset: LifeCycleSavings
...
try:
    try:
        ...
        print('Cargado desde data/LifeCycleSavings.csv')
    except Exception:
        df = pd.read_excel('data/LifeCycleSavings.xlsx', engine='openpyxl')
        print('Cargado desde data/LifeCycleSavings.xlsx')
except Exception:
    try:
