```python
# Código Colab para dataset: baseball
...
try:
    try:
        ...
        print('Cargado desde data/baseball.csv')
    except Exception:
        df = pd.read_excel('data/baseball.xlsx', engine='openpyxl')
        print('Cargado desde data/baseball.xlsx')
except Exception:
    try:
