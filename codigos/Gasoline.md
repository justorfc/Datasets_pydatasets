```python
# Código Colab para dataset: Gasoline
...
try:
    try:
        ...
        print('Cargado desde data/Gasoline.csv')
    except Exception:
        df = pd.read_excel('data/Gasoline.xlsx', engine='openpyxl')
        print('Cargado desde data/Gasoline.xlsx')
except Exception:
    try:
