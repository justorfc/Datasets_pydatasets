```python
# Código Colab para dataset: eagles
...
try:
    try:
        df = pd.read_csv('data/eagles.csv')
        print('Cargado desde data/eagles.csv')
    except Exception:
        df = pd.read_excel('data/eagles.xlsx', engine='openpyxl')
        print('Cargado desde data/eagles.xlsx')
except Exception:
    try:
