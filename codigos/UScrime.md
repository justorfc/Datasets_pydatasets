```python
# Código Colab para dataset: UScrime
...
try:
    try:
        ...
        print('Cargado desde data/UScrime.csv')
    except Exception:
        df = pd.read_excel('data/UScrime.xlsx', engine='openpyxl')
        print('Cargado desde data/UScrime.xlsx')
except Exception:
    try:
