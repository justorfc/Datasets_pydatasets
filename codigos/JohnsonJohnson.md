```python
# Código Colab para dataset: JohnsonJohnson
...
try:
    try:
        ...
        print('Cargado desde data/JohnsonJohnson.csv')
    except Exception:
        df = pd.read_excel('data/JohnsonJohnson.xlsx', engine='openpyxl')
        print('Cargado desde data/JohnsonJohnson.xlsx')
except Exception:
    try:
