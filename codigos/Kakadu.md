```python
# Código Colab para dataset: Kakadu
...
try:
    try:
        df = pd.read_csv('data/Kakadu.csv')
        print('Cargado desde data/Kakadu.csv')
    except Exception:
        df = pd.read_excel('data/Kakadu.xlsx', engine='openpyxl')
        print('Cargado desde data/Kakadu.xlsx')
except Exception:
    try:
