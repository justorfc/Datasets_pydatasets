```python
# Código Colab para dataset: psych
...
try:
    try:
        df = pd.read_csv('data/psych.csv')
        print('Cargado desde data/psych.csv')
    except Exception:
        df = pd.read_excel('data/psych.xlsx', engine='openpyxl')
        print('Cargado desde data/psych.xlsx')
except Exception:
    try:
