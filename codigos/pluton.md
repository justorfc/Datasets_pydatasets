```python
# Código Colab para dataset: pluton
...
try:
    try:
        ...
        print('Cargado desde data/pluton.csv')
    except Exception:
        df = pd.read_excel('data/pluton.xlsx', engine='openpyxl')
        print('Cargado desde data/pluton.xlsx')
except Exception:
    try:
