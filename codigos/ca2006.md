```python
# Código Colab para dataset: ca2006
...
try:
    try:
        df = pd.read_csv('data/ca2006.csv')
        print('Cargado desde data/ca2006.csv')
    except Exception:
        df = pd.read_excel('data/ca2006.xlsx', engine='openpyxl')
        print('Cargado desde data/ca2006.xlsx')
except Exception:
    try:
