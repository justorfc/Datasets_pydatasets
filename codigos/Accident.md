```python
# Código Colab para dataset: Accident
...
try:
    try:
        ...
        print('Cargado desde data/Accident.csv')
    except Exception:
        df = pd.read_excel('data/Accident.xlsx', engine='openpyxl')
        print('Cargado desde data/Accident.xlsx')
except Exception:
    try:
