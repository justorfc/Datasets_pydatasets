```python
# Código Colab para dataset: heptathlon
...
try:
    try:
        ...
        print('Cargado desde data/heptathlon.csv')
    except Exception:
        df = pd.read_excel('data/heptathlon.xlsx', engine='openpyxl')
        print('Cargado desde data/heptathlon.xlsx')
except Exception:
    try:
