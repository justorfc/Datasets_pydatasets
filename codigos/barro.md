```python
# Código Colab para dataset: barro
...
try:
    try:
        df = pd.read_csv('data/barro.csv')
        print('Cargado desde data/barro.csv')
    except Exception:
        df = pd.read_excel('data/barro.xlsx', engine='openpyxl')
        print('Cargado desde data/barro.xlsx')
except Exception:
    try:
