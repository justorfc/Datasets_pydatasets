```python
# Código Colab para dataset: morley
...
try:
    try:
        df = pd.read_csv('data/morley.csv')
        print('Cargado desde data/morley.csv')
    except Exception:
        df = pd.read_excel('data/morley.xlsx', engine='openpyxl')
        print('Cargado desde data/morley.xlsx')
except Exception:
    try:
