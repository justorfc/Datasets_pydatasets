```python
# Código Colab para dataset: freeny
...
try:
    try:
        df = pd.read_csv('data/freeny.csv')
        print('Cargado desde data/freeny.csv')
    except Exception:
        df = pd.read_excel('data/freeny.xlsx', engine='openpyxl')
        print('Cargado desde data/freeny.xlsx')
except Exception:
    try:
