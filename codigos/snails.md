```python
# Código Colab para dataset: snails
...
try:
    try:
        df = pd.read_csv('data/snails.csv')
        print('Cargado desde data/snails.csv')
    except Exception:
        df = pd.read_excel('data/snails.xlsx', engine='openpyxl')
        print('Cargado desde data/snails.xlsx')
except Exception:
    try:
