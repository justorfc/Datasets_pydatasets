```python
# Código Colab para dataset: wtloss
...
try:
    try:
        df = pd.read_csv('data/wtloss.csv')
        print('Cargado desde data/wtloss.csv')
    except Exception:
        df = pd.read_excel('data/wtloss.xlsx', engine='openpyxl')
        print('Cargado desde data/wtloss.xlsx')
except Exception:
    try:
