```python
# Código Colab para dataset: absentee
...
try:
    try:
        df = pd.read_csv('data/absentee.csv')
        print('Cargado desde data/absentee.csv')
    except Exception:
        df = pd.read_excel('data/absentee.xlsx', engine='openpyxl')
        print('Cargado desde data/absentee.xlsx')
except Exception:
    try:
