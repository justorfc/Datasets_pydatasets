```python
# Código Colab para dataset: CYGOB1
...
try:
    try:
        df = pd.read_csv('data/CYGOB1.csv')
        print('Cargado desde data/CYGOB1.csv')
    except Exception:
        df = pd.read_excel('data/CYGOB1.xlsx', engine='openpyxl')
        print('Cargado desde data/CYGOB1.xlsx')
except Exception:
    try:
