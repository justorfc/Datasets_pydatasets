```python
# Código Colab para dataset: respdis
...
try:
    try:
        df = pd.read_csv('data/respdis.csv')
        print('Cargado desde data/respdis.csv')
    except Exception:
        df = pd.read_excel('data/respdis.xlsx', engine='openpyxl')
        print('Cargado desde data/respdis.xlsx')
except Exception:
    try:
