```python
# Código Colab para dataset: aircondit
...
try:
    try:
        df = pd.read_csv('data/aircondit.csv')
        print('Cargado desde data/aircondit.csv')
    except Exception:
        df = pd.read_excel('data/aircondit.xlsx', engine='openpyxl')
        print('Cargado desde data/aircondit.xlsx')
except Exception:
    try:
