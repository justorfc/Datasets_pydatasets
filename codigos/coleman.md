```python
# Código Colab para dataset: coleman
...
try:
    try:
        df = pd.read_csv('data/coleman.csv')
        print('Cargado desde data/coleman.csv')
    except Exception:
        df = pd.read_excel('data/coleman.xlsx', engine='openpyxl')
        print('Cargado desde data/coleman.xlsx')
except Exception:
    try:
