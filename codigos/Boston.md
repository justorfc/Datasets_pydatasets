```python
# Código Colab para dataset: Boston
...
try:
    try:
        ...
        print('Cargado desde data/Boston.csv')
    except Exception:
        df = pd.read_excel('data/Boston.xlsx', engine='openpyxl')
        print('Cargado desde data/Boston.xlsx')
except Exception:
    try:
