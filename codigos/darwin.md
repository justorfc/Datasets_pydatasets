```python
# Código Colab para dataset: darwin
...
try:
    try:
        ...
        print('Cargado desde data/darwin.csv')
    except Exception:
        df = pd.read_excel('data/darwin.xlsx', engine='openpyxl')
        print('Cargado desde data/darwin.xlsx')
except Exception:
    try:
