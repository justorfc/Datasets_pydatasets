...
try:
    try:
        df = pd.read_csv('data/hbk.csv')
        print('Cargado desde data/hbk.csv')
    except Exception:
        df = pd.read_excel('data/hbk.xlsx', engine='openpyxl')
        print('Cargado desde data/hbk.xlsx')
except Exception:
    try:
