```python
# Código Colab para dataset: Quarrels
...
try:
    try:
        df = pd.read_csv('data/Quarrels.csv')
        print('Cargado desde data/Quarrels.csv')
    except Exception:
        df = pd.read_excel('data/Quarrels.xlsx', engine='openpyxl')
        print('Cargado desde data/Quarrels.xlsx')
except Exception:
    try:
