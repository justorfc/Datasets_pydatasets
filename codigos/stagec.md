```python
# Código Colab para dataset: stagec
...
try:
    try:
        df = pd.read_csv('data/stagec.csv')
        print('Cargado desde data/stagec.csv')
    except Exception:
        df = pd.read_excel('data/stagec.xlsx', engine='openpyxl')
        print('Cargado desde data/stagec.xlsx')
except Exception:
    try:
