```python
# Código Colab para dataset: rats
...
try:
    try:
        df = pd.read_csv('data/rats.csv')
        print('Cargado desde data/rats.csv')
    except Exception:
        df = pd.read_excel('data/rats.xlsx', engine='openpyxl')
        print('Cargado desde data/rats.xlsx')
except Exception:
    try:
