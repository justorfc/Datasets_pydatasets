```python
# Código Colab para dataset: Airline
...
try:
    try:
        ...
        print('Cargado desde data/Airline.csv')
    except Exception:
        df = pd.read_excel('data/Airline.xlsx', engine='openpyxl')
        print('Cargado desde data/Airline.xlsx')
except Exception:
    try:
