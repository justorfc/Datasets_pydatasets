```python
# Código Colab para dataset: calcium
...
try:
    try:
        df = pd.read_csv('data/calcium.csv')
        print('Cargado desde data/calcium.csv')
    except Exception:
        df = pd.read_excel('data/calcium.xlsx', engine='openpyxl')
        print('Cargado desde data/calcium.xlsx')
except Exception:
    try:
