```python
# Código Colab para dataset: longley
...
try:
    try:
        ...
        print('Cargado desde data/longley.csv')
    except Exception:
        df = pd.read_excel('data/longley.xlsx', engine='openpyxl')
        print('Cargado desde data/longley.xlsx')
except Exception:
    try:
