```python
# Código Colab para dataset: frets
...
try:
    try:
        df = pd.read_csv('data/frets.csv')
        print('Cargado desde data/frets.csv')
    except Exception:
        df = pd.read_excel('data/frets.xlsx', engine='openpyxl')
        print('Cargado desde data/frets.xlsx')
except Exception:
    try:
