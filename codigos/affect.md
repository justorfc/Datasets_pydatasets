```python
# Código Colab para dataset: affect
...
try:
    try:
        df = pd.read_csv('data/affect.csv')
        print('Cargado desde data/affect.csv')
    except Exception:
        df = pd.read_excel('data/affect.xlsx', engine='openpyxl')
        print('Cargado desde data/affect.xlsx')
except Exception:
    try:
