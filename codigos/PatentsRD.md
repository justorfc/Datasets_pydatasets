```python
# Código Colab para dataset: PatentsRD
...
try:
    try:
        df = pd.read_csv('data/PatentsRD.csv')
        print('Cargado desde data/PatentsRD.csv')
    except Exception:
        df = pd.read_excel('data/PatentsRD.xlsx', engine='openpyxl')
        print('Cargado desde data/PatentsRD.xlsx')
except Exception:
    try:
