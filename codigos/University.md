```python
# Código Colab para dataset: University
...
try:
    try:
        ...
        print('Cargado desde data/University.csv')
    except Exception:
        df = pd.read_excel('data/University.xlsx', engine='openpyxl')
        print('Cargado desde data/University.xlsx')
except Exception:
    try:
