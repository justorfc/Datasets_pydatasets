```python
# Código Colab para dataset: azpro
...
try:
    try:
        df = pd.read_csv('data/azpro.csv')
        print('Cargado desde data/azpro.csv')
    except Exception:
        df = pd.read_excel('data/azpro.xlsx', engine='openpyxl')
        print('Cargado desde data/azpro.xlsx')
except Exception:
    try:
