```python
# Código Colab para dataset: geyser
...
try:
    try:
        ...
        print('Cargado desde data/geyser.csv')
    except Exception:
        df = pd.read_excel('data/geyser.xlsx', engine='openpyxl')
        print('Cargado desde data/geyser.xlsx')
except Exception:
    try:
