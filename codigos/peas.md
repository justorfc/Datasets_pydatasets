```python
# Código Colab para dataset: peas
...
try:
    try:
        df = pd.read_csv('data/peas.csv')
        print('Cargado desde data/peas.csv')
    except Exception:
        df = pd.read_excel('data/peas.xlsx', engine='openpyxl')
        print('Cargado desde data/peas.xlsx')
except Exception:
    try:
