```python
# Código Colab para dataset: burt
...
try:
    try:
        df = pd.read_csv('data/burt.csv')
        print('Cargado desde data/burt.csv')
    except Exception:
        df = pd.read_excel('data/burt.xlsx', engine='openpyxl')
        print('Cargado desde data/burt.xlsx')
except Exception:
    try:
