```python
# Código Colab para dataset: gehan
...
try:
    try:
        df = pd.read_csv('data/gehan.csv')
        print('Cargado desde data/gehan.csv')
    except Exception:
        df = pd.read_excel('data/gehan.xlsx', engine='openpyxl')
        print('Cargado desde data/gehan.xlsx')
except Exception:
    try:
