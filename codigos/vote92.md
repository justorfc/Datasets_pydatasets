```python
# Código Colab para dataset: vote92
...
try:
    try:
        ...
        print('Cargado desde data/vote92.csv')
    except Exception:
        df = pd.read_excel('data/vote92.xlsx', engine='openpyxl')
        print('Cargado desde data/vote92.xlsx')
except Exception:
    try:
