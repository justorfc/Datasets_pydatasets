```python
# Código Colab para dataset: sitka89
...
try:
    try:
        df = pd.read_csv('data/sitka89.csv')
        print('Cargado desde data/sitka89.csv')
    except Exception:
        df = pd.read_excel('data/sitka89.xlsx', engine='openpyxl')
        print('Cargado desde data/sitka89.xlsx')
except Exception:
    try:
