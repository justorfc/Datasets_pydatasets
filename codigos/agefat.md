```python
# Código Colab para dataset: agefat
...
try:
    try:
        df = pd.read_csv('data/agefat.csv')
        print('Cargado desde data/agefat.csv')
    except Exception:
        df = pd.read_excel('data/agefat.xlsx', engine='openpyxl')
        print('Cargado desde data/agefat.xlsx')
except Exception:
    try:
