```python
# Código Colab para dataset: loomis
...
try:
    try:
        df = pd.read_csv('data/loomis.csv')
        print('Cargado desde data/loomis.csv')
    except Exception:
        df = pd.read_excel('data/loomis.xlsx', engine='openpyxl')
        print('Cargado desde data/loomis.xlsx')
except Exception:
    try:
