```python
# Código Colab para dataset: agriculture
...
try:
    try:
        ...
        print('Cargado desde data/agriculture.csv')
    except Exception:
        df = pd.read_excel('data/agriculture.xlsx', engine='openpyxl')
        print('Cargado desde data/agriculture.xlsx')
except Exception:
    try:
