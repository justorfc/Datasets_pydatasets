...
try:
    try:
        df = pd.read_csv('data/fgl.csv')
        print('Cargado desde data/fgl.csv')
    except Exception:
        df = pd.read_excel('data/fgl.xlsx', engine='openpyxl')
        print('Cargado desde data/fgl.xlsx')
except Exception:
    try:
