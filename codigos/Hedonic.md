```python
# Código Colab para dataset: Hedonic
...
try:
    try:
        df = pd.read_csv('data/Hedonic.csv')
        print('Cargado desde data/Hedonic.csv')
    except Exception:
        df = pd.read_excel('data/Hedonic.xlsx', engine='openpyxl')
        print('Cargado desde data/Hedonic.xlsx')
except Exception:
    try:
