```python
# Código Colab para dataset: kidrecurr
...
try:
    try:
        df = pd.read_csv('data/kidrecurr.csv')
        print('Cargado desde data/kidrecurr.csv')
    except Exception:
        df = pd.read_excel('data/kidrecurr.xlsx', engine='openpyxl')
        print('Cargado desde data/kidrecurr.xlsx')
except Exception:
    try:
