```python
# Código Colab para dataset: Hitters
...
try:
    try:
        ...
        print('Cargado desde data/Hitters.csv')
    except Exception:
        df = pd.read_excel('data/Hitters.xlsx', engine='openpyxl')
        print('Cargado desde data/Hitters.xlsx')
except Exception:
    try:
