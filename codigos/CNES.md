```python
# Código Colab para dataset: CNES
...
try:
    try:
        df = pd.read_csv('data/CNES.csv')
        print('Cargado desde data/CNES.csv')
    except Exception:
        df = pd.read_excel('data/CNES.xlsx', engine='openpyxl')
        print('Cargado desde data/CNES.xlsx')
except Exception:
    try:
