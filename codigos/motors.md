```python
# Código Colab para dataset: motors
...
try:
    try:
        df = pd.read_csv('data/motors.csv')
        print('Cargado desde data/motors.csv')
    except Exception:
        df = pd.read_excel('data/motors.xlsx', engine='openpyxl')
        print('Cargado desde data/motors.xlsx')
except Exception:
    try:
