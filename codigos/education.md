```python
# Código Colab para dataset: education
...
try:
    try:
        ...
        print('Cargado desde data/education.csv')
    except Exception:
        df = pd.read_excel('data/education.xlsx', engine='openpyxl')
        print('Cargado desde data/education.xlsx')
except Exception:
    try:
