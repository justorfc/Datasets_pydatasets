```python
# Código Colab para dataset: waders
...
try:
    try:
        df = pd.read_csv('data/waders.csv')
        print('Cargado desde data/waders.csv')
    except Exception:
        df = pd.read_excel('data/waders.xlsx', engine='openpyxl')
        print('Cargado desde data/waders.xlsx')
except Exception:
    try:
