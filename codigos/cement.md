```python
# Código Colab para dataset: cement
...
try:
    try:
        ...
        print('Cargado desde data/cement.csv')
    except Exception:
        df = pd.read_excel('data/cement.xlsx', engine='openpyxl')
        print('Cargado desde data/cement.xlsx')
except Exception:
    try:
