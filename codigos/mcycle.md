```python
# Código Colab para dataset: mcycle
...
try:
    try:
        ...
        print('Cargado desde data/mcycle.csv')
    except Exception:
        df = pd.read_excel('data/mcycle.xlsx', engine='openpyxl')
        print('Cargado desde data/mcycle.xlsx')
except Exception:
    try:
