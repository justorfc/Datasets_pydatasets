```python
# Código Colab para dataset: Duncan
...
try:
    try:
        ...
        print('Cargado desde data/Duncan.csv')
    except Exception:
        df = pd.read_excel('data/Duncan.xlsx', engine='openpyxl')
        print('Cargado desde data/Duncan.xlsx')
except Exception:
    try:
