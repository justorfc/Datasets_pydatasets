```python
# Código Colab para dataset: forbes
...
try:
    try:
        ...
        print('Cargado desde data/forbes.csv')
    except Exception:
        df = pd.read_excel('data/forbes.xlsx', engine='openpyxl')
        print('Cargado desde data/forbes.xlsx')
except Exception:
    try:
