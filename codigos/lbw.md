...
try:
    try:
        df = pd.read_csv('data/lbw.csv')
        print('Cargado desde data/lbw.csv')
    except Exception:
        df = pd.read_excel('data/lbw.xlsx', engine='openpyxl')
        print('Cargado desde data/lbw.xlsx')
except Exception:
    try:
