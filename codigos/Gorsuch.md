```python
# Código Colab para dataset: Gorsuch
...
try:
    try:
        df = pd.read_csv('data/Gorsuch.csv')
        print('Cargado desde data/Gorsuch.csv')
    except Exception:
        df = pd.read_excel('data/Gorsuch.xlsx', engine='openpyxl')
        print('Cargado desde data/Gorsuch.xlsx')
except Exception:
    try:
