```python
# Código Colab para dataset: Blackmoor
...
try:
    try:
        df = pd.read_csv('data/Blackmoor.csv')
        print('Cargado desde data/Blackmoor.csv')
    except Exception:
        df = pd.read_excel('data/Blackmoor.xlsx', engine='openpyxl')
        print('Cargado desde data/Blackmoor.xlsx')
except Exception:
    try:
