```python
# Código Colab para dataset: cabbages
...
try:
    try:
        df = pd.read_csv('data/cabbages.csv')
        print('Cargado desde data/cabbages.csv')
    except Exception:
        df = pd.read_excel('data/cabbages.xlsx', engine='openpyxl')
        print('Cargado desde data/cabbages.xlsx')
except Exception:
    try:
