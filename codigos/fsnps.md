```python
# Código Colab para dataset: fsnps
...
try:
    try:
        df = pd.read_csv('data/fsnps.csv')
        print('Cargado desde data/fsnps.csv')
    except Exception:
        df = pd.read_excel('data/fsnps.xlsx', engine='openpyxl')
        print('Cargado desde data/fsnps.xlsx')
except Exception:
    try:
