```python
# Código Colab para dataset: bcdeter
...
try:
    try:
        df = pd.read_csv('data/bcdeter.csv')
        print('Cargado desde data/bcdeter.csv')
    except Exception:
        df = pd.read_excel('data/bcdeter.xlsx', engine='openpyxl')
        print('Cargado desde data/bcdeter.xlsx')
except Exception:
    try:
