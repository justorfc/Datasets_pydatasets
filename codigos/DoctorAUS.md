```python
# Código Colab para dataset: DoctorAUS
...
try:
    try:
        df = pd.read_csv('data/DoctorAUS.csv')
        print('Cargado desde data/DoctorAUS.csv')
    except Exception:
        df = pd.read_excel('data/DoctorAUS.xlsx', engine='openpyxl')
        print('Cargado desde data/DoctorAUS.xlsx')
except Exception:
    try:
