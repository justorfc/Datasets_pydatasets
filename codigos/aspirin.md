```python
# Código Colab para dataset: aspirin
...
try:
    try:
        df = pd.read_csv('data/aspirin.csv')
        print('Cargado desde data/aspirin.csv')
    except Exception:
        df = pd.read_excel('data/aspirin.xlsx', engine='openpyxl')
        print('Cargado desde data/aspirin.xlsx')
except Exception:
    try:
