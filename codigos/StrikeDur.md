```python
# Código Colab para dataset: StrikeDur
...
try:
    try:
        df = pd.read_csv('data/StrikeDur.csv')
        print('Cargado desde data/StrikeDur.csv')
    except Exception:
        df = pd.read_excel('data/StrikeDur.xlsx', engine='openpyxl')
        print('Cargado desde data/StrikeDur.xlsx')
except Exception:
    try:
