```python
# Código Colab para dataset: Bowley
...
try:
    try:
        df = pd.read_csv('data/Bowley.csv')
        print('Cargado desde data/Bowley.csv')
    except Exception:
        df = pd.read_excel('data/Bowley.xlsx', engine='openpyxl')
        print('Cargado desde data/Bowley.xlsx')
except Exception:
    try:
