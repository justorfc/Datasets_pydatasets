```python
# Código Colab para dataset: Treatment
...
try:
    try:
        ...
        print('Cargado desde data/Treatment.csv')
    except Exception:
        df = pd.read_excel('data/Treatment.xlsx', engine='openpyxl')
        print('Cargado desde data/Treatment.xlsx')
except Exception:
    try:
