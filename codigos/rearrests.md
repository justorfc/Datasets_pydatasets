```python
# Código Colab para dataset: rearrests
...
try:
    try:
        df = pd.read_csv('data/rearrests.csv')
        print('Cargado desde data/rearrests.csv')
    except Exception:
        df = pd.read_excel('data/rearrests.xlsx', engine='openpyxl')
        print('Cargado desde data/rearrests.xlsx')
except Exception:
    try:
