```python
# Código Colab para dataset: chickwts
...
try:
    try:
        ...
        print('Cargado desde data/chickwts.csv')
    except Exception:
        df = pd.read_excel('data/chickwts.xlsx', engine='openpyxl')
        print('Cargado desde data/chickwts.xlsx')
except Exception:
    try:
