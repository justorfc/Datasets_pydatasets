```python
# Código Colab para dataset: petrol
...
try:
    try:
        df = pd.read_csv('data/petrol.csv')
        print('Cargado desde data/petrol.csv')
    except Exception:
        df = pd.read_excel('data/petrol.xlsx', engine='openpyxl')
        print('Cargado desde data/petrol.xlsx')
except Exception:
    try:
