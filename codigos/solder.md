```python
# Código Colab para dataset: solder
...
try:
    try:
        df = pd.read_csv('data/solder.csv')
        print('Cargado desde data/solder.csv')
    except Exception:
        df = pd.read_excel('data/solder.xlsx', engine='openpyxl')
        print('Cargado desde data/solder.xlsx')
except Exception:
    try:
