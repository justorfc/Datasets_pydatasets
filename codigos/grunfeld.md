```python
# Código Colab para dataset: grunfeld
...
try:
    try:
        ...
        print('Cargado desde data/grunfeld.csv')
    except Exception:
        df = pd.read_excel('data/grunfeld.xlsx', engine='openpyxl')
        print('Cargado desde data/grunfeld.xlsx')
except Exception:
    try:
