```python
# Código Colab para dataset: Cowles
...
try:
    try:
        df = pd.read_csv('data/Cowles.csv')
        print('Cargado desde data/Cowles.csv')
    except Exception:
        df = pd.read_excel('data/Cowles.xlsx', engine='openpyxl')
        print('Cargado desde data/Cowles.xlsx')
except Exception:
    try:
