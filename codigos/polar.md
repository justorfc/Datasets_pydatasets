```python
# Código Colab para dataset: polar
...
try:
    try:
        df = pd.read_csv('data/polar.csv')
        print('Cargado desde data/polar.csv')
    except Exception:
        df = pd.read_excel('data/polar.xlsx', engine='openpyxl')
        print('Cargado desde data/polar.xlsx')
except Exception:
    try:
