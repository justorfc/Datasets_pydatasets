```python
# Código Colab para dataset: foster
...
try:
    try:
        df = pd.read_csv('data/foster.csv')
        print('Cargado desde data/foster.csv')
    except Exception:
        df = pd.read_excel('data/foster.xlsx', engine='openpyxl')
        print('Cargado desde data/foster.xlsx')
except Exception:
    try:
