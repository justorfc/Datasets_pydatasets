```python
# Código Colab para dataset: Leinhardt
...
try:
    try:
        df = pd.read_csv('data/Leinhardt.csv')
        print('Cargado desde data/Leinhardt.csv')
    except Exception:
        df = pd.read_excel('data/Leinhardt.xlsx', engine='openpyxl')
        print('Cargado desde data/Leinhardt.xlsx')
except Exception:
    try:
