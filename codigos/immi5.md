```python
# Código Colab para dataset: immi5
...
try:
    try:
        df = pd.read_csv('data/immi5.csv')
        print('Cargado desde data/immi5.csv')
    except Exception:
        df = pd.read_excel('data/immi5.xlsx', engine='openpyxl')
        print('Cargado desde data/immi5.xlsx')
except Exception:
    try:
