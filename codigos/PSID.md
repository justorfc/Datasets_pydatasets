```python
# Código Colab para dataset: PSID
...
try:
    try:
        df = pd.read_csv('data/PSID.csv')
        print('Cargado desde data/PSID.csv')
    except Exception:
        df = pd.read_excel('data/PSID.xlsx', engine='openpyxl')
        print('Cargado desde data/PSID.xlsx')
except Exception:
    try:
