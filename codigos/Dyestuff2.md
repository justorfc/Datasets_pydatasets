```python
# Código Colab para dataset: Dyestuff2
...
try:
    try:
        ...
        print('Cargado desde data/Dyestuff2.csv')
    except Exception:
        df = pd.read_excel('data/Dyestuff2.xlsx', engine='openpyxl')
        print('Cargado desde data/Dyestuff2.xlsx')
except Exception:
    try:
