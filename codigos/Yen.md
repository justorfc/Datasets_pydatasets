...
try:
    try:
        df = pd.read_csv('data/Yen.csv')
        print('Cargado desde data/Yen.csv')
    except Exception:
        df = pd.read_excel('data/Yen.xlsx', engine='openpyxl')
        print('Cargado desde data/Yen.xlsx')
except Exception:
    try:
