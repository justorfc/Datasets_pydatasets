```python
# Código Colab para dataset: synth.te
...
try:
    try:
        df = pd.read_csv('data/synth.te.csv')
        print('Cargado desde data/synth.te.csv')
    except Exception:
        df = pd.read_excel('data/synth.te.xlsx', engine='openpyxl')
        print('Cargado desde data/synth.te.xlsx')
except Exception:
    try:
