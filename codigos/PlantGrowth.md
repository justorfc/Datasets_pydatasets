```python
# Código Colab para dataset: PlantGrowth
...
try:
    try:
        ...
        print('Cargado desde data/PlantGrowth.csv')
    except Exception:
        df = pd.read_excel('data/PlantGrowth.xlsx', engine='openpyxl')
        print('Cargado desde data/PlantGrowth.xlsx')
except Exception:
    try:
