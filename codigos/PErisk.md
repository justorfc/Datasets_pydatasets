```python
# Código Colab para dataset: PErisk
...
try:
    try:
        df = pd.read_csv('data/PErisk.csv')
        print('Cargado desde data/PErisk.csv')
    except Exception:
        df = pd.read_excel('data/PErisk.xlsx', engine='openpyxl')
        print('Cargado desde data/PErisk.xlsx')
except Exception:
    try:
