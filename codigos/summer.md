```python
# Código Colab para dataset: summer
...
try:
    try:
        ...
        print('Cargado desde data/summer.csv')
    except Exception:
        df = pd.read_excel('data/summer.xlsx', engine='openpyxl')
        print('Cargado desde data/summer.xlsx')
except Exception:
    try:
