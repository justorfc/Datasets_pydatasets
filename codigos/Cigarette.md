```python
# Código Colab para dataset: Cigarette
...
try:
    try:
        df = pd.read_csv('data/Cigarette.csv')
        print('Cargado desde data/Cigarette.csv')
    except Exception:
        df = pd.read_excel('data/Cigarette.xlsx', engine='openpyxl')
        print('Cargado desde data/Cigarette.xlsx')
except Exception:
    try:
