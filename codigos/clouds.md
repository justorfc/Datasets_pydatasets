```python
# Código Colab para dataset: clouds
...
try:
    try:
        ...
        print('Cargado desde data/clouds.csv')
    except Exception:
        df = pd.read_excel('data/clouds.xlsx', engine='openpyxl')
        print('Cargado desde data/clouds.xlsx')
except Exception:
    try:
