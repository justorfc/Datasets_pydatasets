```python
# Código Colab para dataset: galton
...
try:
    try:
        ...
        print('Cargado desde data/galton.csv')
    except Exception:
        df = pd.read_excel('data/galton.xlsx', engine='openpyxl')
        print('Cargado desde data/galton.xlsx')
except Exception:
    try:
