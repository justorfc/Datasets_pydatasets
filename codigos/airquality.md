```python
# Código Colab para dataset: airquality
...
try:
    try:
        ...
        print('Cargado desde data/airquality.csv')
    except Exception:
        df = pd.read_excel('data/airquality.xlsx', engine='openpyxl')
        print('Cargado desde data/airquality.xlsx')
except Exception:
    try:
