```python
# Código Colab para dataset: Fishing
...
try:
    try:
        df = pd.read_csv('data/Fishing.csv')
        print('Cargado desde data/Fishing.csv')
    except Exception:
        df = pd.read_excel('data/Fishing.xlsx', engine='openpyxl')
        print('Cargado desde data/Fishing.xlsx')
except Exception:
    try:
