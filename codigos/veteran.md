```python
# Código Colab para dataset: veteran
...
try:
    try:
        ...
        print('Cargado desde data/veteran.csv')
    except Exception:
        df = pd.read_excel('data/veteran.xlsx', engine='openpyxl')
        print('Cargado desde data/veteran.xlsx')
except Exception:
    try:
