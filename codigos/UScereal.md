```python
# Código Colab para dataset: UScereal
...
try:
    try:
        ...
        print('Cargado desde data/UScereal.csv')
    except Exception:
        df = pd.read_excel('data/UScereal.xlsx', engine='openpyxl')
        print('Cargado desde data/UScereal.xlsx')
except Exception:
    try:
