...
try:
    try:
        df = pd.read_csv('data/BOD.csv')
        print('Cargado desde data/BOD.csv')
    except Exception:
        df = pd.read_excel('data/BOD.xlsx', engine='openpyxl')
        print('Cargado desde data/BOD.xlsx')
except Exception:
    try:
