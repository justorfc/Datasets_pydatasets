```python
# Código Colab para dataset: airmay
...
try:
    try:
        df = pd.read_csv('data/airmay.csv')
        print('Cargado desde data/airmay.csv')
    except Exception:
        df = pd.read_excel('data/airmay.xlsx', engine='openpyxl')
        print('Cargado desde data/airmay.xlsx')
except Exception:
    try:
