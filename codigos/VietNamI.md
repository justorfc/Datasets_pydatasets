```python
# Código Colab para dataset: VietNamI
...
try:
    try:
        df = pd.read_csv('data/VietNamI.csv')
        print('Cargado desde data/VietNamI.csv')
    except Exception:
        df = pd.read_excel('data/VietNamI.xlsx', engine='openpyxl')
        print('Cargado desde data/VietNamI.xlsx')
except Exception:
    try:
