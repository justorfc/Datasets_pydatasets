```python
# Código Colab para dataset: UCBAdmissions
...
try:
    try:
        ...
        print('Cargado desde data/UCBAdmissions.csv')
    except Exception:
        df = pd.read_excel('data/UCBAdmissions.xlsx', engine='openpyxl')
        print('Cargado desde data/UCBAdmissions.xlsx')
except Exception:
    try:
