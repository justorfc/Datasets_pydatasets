```python
# Código Colab para dataset: claridge
...
try:
    try:
        df = pd.read_csv('data/claridge.csv')
        print('Cargado desde data/claridge.csv')
    except Exception:
        df = pd.read_excel('data/claridge.xlsx', engine='openpyxl')
        print('Cargado desde data/claridge.xlsx')
except Exception:
    try:
