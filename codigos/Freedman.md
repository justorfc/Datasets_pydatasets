```python
# Código Colab para dataset: Freedman
...
try:
    try:
        df = pd.read_csv('data/Freedman.csv')
        print('Cargado desde data/Freedman.csv')
    except Exception:
        df = pd.read_excel('data/Freedman.xlsx', engine='openpyxl')
        print('Cargado desde data/Freedman.xlsx')
except Exception:
    try:
