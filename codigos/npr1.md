```python
# Código Colab para dataset: npr1
...
try:
    try:
        df = pd.read_csv('data/npr1.csv')
        print('Cargado desde data/npr1.csv')
    except Exception:
        df = pd.read_excel('data/npr1.xlsx', engine='openpyxl')
        print('Cargado desde data/npr1.xlsx')
except Exception:
    try:
