```python
# Código Colab para dataset: gravity
...
try:
    try:
        ...
        print('Cargado desde data/gravity.csv')
    except Exception:
        df = pd.read_excel('data/gravity.xlsx', engine='openpyxl')
        print('Cargado desde data/gravity.xlsx')
except Exception:
    try:
