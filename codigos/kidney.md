```python
# Código Colab para dataset: kidney
...
try:
    try:
        ...
        print('Cargado desde data/kidney.csv')
    except Exception:
        df = pd.read_excel('data/kidney.xlsx', engine='openpyxl')
        print('Cargado desde data/kidney.xlsx')
except Exception:
    try:
