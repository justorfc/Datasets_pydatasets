```python
# Código Colab para dataset: mastectomy
...
try:
    try:
        ...
        print('Cargado desde data/mastectomy.csv')
    except Exception:
        df = pd.read_excel('data/mastectomy.xlsx', engine='openpyxl')
        print('Cargado desde data/mastectomy.xlsx')
except Exception:
    try:
