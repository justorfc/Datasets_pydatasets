```python
# Código Colab para dataset: leuk
...
try:
    try:
        df = pd.read_csv('data/leuk.csv')
        print('Cargado desde data/leuk.csv')
    except Exception:
        df = pd.read_excel('data/leuk.xlsx', engine='openpyxl')
        print('Cargado desde data/leuk.xlsx')
except Exception:
    try:
