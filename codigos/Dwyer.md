```python
# Código Colab para dataset: Dwyer
...
try:
    try:
        df = pd.read_csv('data/Dwyer.csv')
        print('Cargado desde data/Dwyer.csv')
    except Exception:
        df = pd.read_excel('data/Dwyer.xlsx', engine='openpyxl')
        print('Cargado desde data/Dwyer.xlsx')
except Exception:
    try:
