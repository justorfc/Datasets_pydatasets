```python
# Código Colab para dataset: Thurstone
...
try:
    try:
        df = pd.read_csv('data/Thurstone.csv')
        print('Cargado desde data/Thurstone.csv')
    except Exception:
        df = pd.read_excel('data/Thurstone.xlsx', engine='openpyxl')
        print('Cargado desde data/Thurstone.xlsx')
except Exception:
    try:
