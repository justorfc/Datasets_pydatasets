```python
# Código Colab para dataset: stanford2
...
try:
    try:
        ...
        print('Cargado desde data/stanford2.csv')
    except Exception:
        df = pd.read_excel('data/stanford2.xlsx', engine='openpyxl')
        print('Cargado desde data/stanford2.xlsx')
except Exception:
    try:
