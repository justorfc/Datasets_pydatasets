```python
# Código Colab para dataset: aldh2
...
try:
    try:
        df = pd.read_csv('data/aldh2.csv')
        print('Cargado desde data/aldh2.csv')
    except Exception:
        df = pd.read_excel('data/aldh2.xlsx', engine='openpyxl')
        print('Cargado desde data/aldh2.xlsx')
except Exception:
    try:
