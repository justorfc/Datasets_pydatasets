```python
# Código Colab para dataset: Transact
...
try:
    try:
        df = pd.read_csv('data/Transact.csv')
        print('Cargado desde data/Transact.csv')
    except Exception:
        df = pd.read_excel('data/Transact.xlsx', engine='openpyxl')
        print('Cargado desde data/Transact.xlsx')
except Exception:
    try:
