```python
# Código Colab para dataset: approval
...
try:
    try:
        ...
        print('Cargado desde data/approval.csv')
    except Exception:
        df = pd.read_excel('data/approval.xlsx', engine='openpyxl')
        print('Cargado desde data/approval.xlsx')
except Exception:
    try:
