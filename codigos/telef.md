```python
# Código Colab para dataset: telef
...
try:
    try:
        df = pd.read_csv('data/telef.csv')
        print('Cargado desde data/telef.csv')
    except Exception:
        df = pd.read_excel('data/telef.xlsx', engine='openpyxl')
        print('Cargado desde data/telef.xlsx')
except Exception:
    try:
