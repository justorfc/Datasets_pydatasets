```python
# Código Colab para dataset: treering
...
try:
    try:
        df = pd.read_csv('data/treering.csv')
        print('Cargado desde data/treering.csv')
    except Exception:
        df = pd.read_excel('data/treering.xlsx', engine='openpyxl')
        print('Cargado desde data/treering.xlsx')
except Exception:
    try:
