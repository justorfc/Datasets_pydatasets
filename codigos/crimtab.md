```python
# Código Colab para dataset: crimtab
...
try:
    try:
        df = pd.read_csv('data/crimtab.csv')
        print('Cargado desde data/crimtab.csv')
    except Exception:
        df = pd.read_excel('data/crimtab.xlsx', engine='openpyxl')
        print('Cargado desde data/crimtab.xlsx')
except Exception:
    try:
