```python
# Código Colab para dataset: caith
...
try:
    try:
        df = pd.read_csv('data/caith.csv')
        print('Cargado desde data/caith.csv')
    except Exception:
        df = pd.read_excel('data/caith.xlsx', engine='openpyxl')
        print('Cargado desde data/caith.xlsx')
except Exception:
    try:
