```python
# Código Colab para dataset: CrohnD
...
try:
    try:
        df = pd.read_csv('data/CrohnD.csv')
        print('Cargado desde data/CrohnD.csv')
    except Exception:
        df = pd.read_excel('data/CrohnD.xlsx', engine='openpyxl')
        print('Cargado desde data/CrohnD.xlsx')
except Exception:
    try:
