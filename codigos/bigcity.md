```python
# Código Colab para dataset: bigcity
...
try:
    try:
        df = pd.read_csv('data/bigcity.csv')
        print('Cargado desde data/bigcity.csv')
    except Exception:
        df = pd.read_excel('data/bigcity.xlsx', engine='openpyxl')
        print('Cargado desde data/bigcity.xlsx')
except Exception:
    try:
