```python
# Código Colab para dataset: TranspEq
...
try:
    try:
        df = pd.read_csv('data/TranspEq.csv')
        print('Cargado desde data/TranspEq.csv')
    except Exception:
        df = pd.read_excel('data/TranspEq.xlsx', engine='openpyxl')
        print('Cargado desde data/TranspEq.xlsx')
except Exception:
    try:
