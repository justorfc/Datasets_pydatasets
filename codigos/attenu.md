```python
# Código Colab para dataset: attenu
...
try:
    try:
        df = pd.read_csv('data/attenu.csv')
        print('Cargado desde data/attenu.csv')
    except Exception:
        df = pd.read_excel('data/attenu.xlsx', engine='openpyxl')
        print('Cargado desde data/attenu.xlsx')
except Exception:
    try:
