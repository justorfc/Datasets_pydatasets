```python
# Código Colab para dataset: barley
...
try:
    try:
        df = pd.read_csv('data/barley.csv')
        print('Cargado desde data/barley.csv')
    except Exception:
        df = pd.read_excel('data/barley.xlsx', engine='openpyxl')
        print('Cargado desde data/barley.xlsx')
except Exception:
    try:
