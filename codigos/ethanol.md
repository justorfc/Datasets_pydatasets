```python
# Código Colab para dataset: ethanol
...
try:
    try:
        df = pd.read_csv('data/ethanol.csv')
        print('Cargado desde data/ethanol.csv')
    except Exception:
        df = pd.read_excel('data/ethanol.xlsx', engine='openpyxl')
        print('Cargado desde data/ethanol.xlsx')
except Exception:
    try:
