```python
# Código Colab para dataset: iraqVote
...
try:
    try:
        df = pd.read_csv('data/iraqVote.csv')
        print('Cargado desde data/iraqVote.csv')
    except Exception:
        df = pd.read_excel('data/iraqVote.xlsx', engine='openpyxl')
        print('Cargado desde data/iraqVote.xlsx')
except Exception:
    try:
