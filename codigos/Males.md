```python
# Código Colab para dataset: Males
...
try:
    try:
        df = pd.read_csv('data/Males.csv')
        print('Cargado desde data/Males.csv')
    except Exception:
        df = pd.read_excel('data/Males.xlsx', engine='openpyxl')
        print('Cargado desde data/Males.xlsx')
except Exception:
    try:
