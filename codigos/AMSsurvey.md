```python
# Código Colab para dataset: AMSsurvey
...
try:
    try:
        df = pd.read_csv('data/AMSsurvey.csv')
        print('Cargado desde data/AMSsurvey.csv')
    except Exception:
        df = pd.read_excel('data/AMSsurvey.xlsx', engine='openpyxl')
        print('Cargado desde data/AMSsurvey.xlsx')
except Exception:
    try:
