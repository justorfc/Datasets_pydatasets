```python
# Código Colab para dataset: Lanza
...
try:
    try:
        df = pd.read_csv('data/Lanza.csv')
        print('Cargado desde data/Lanza.csv')
    except Exception:
        df = pd.read_excel('data/Lanza.xlsx', engine='openpyxl')
        print('Cargado desde data/Lanza.xlsx')
except Exception:
    try:
