```python
# Código Colab para dataset: roomwidth
...
try:
    try:
        df = pd.read_csv('data/roomwidth.csv')
        print('Cargado desde data/roomwidth.csv')
    except Exception:
        df = pd.read_excel('data/roomwidth.xlsx', engine='openpyxl')
        print('Cargado desde data/roomwidth.xlsx')
except Exception:
    try:
