```python
# Código Colab para dataset: volcano
...
try:
    try:
        ...
        print('Cargado desde data/volcano.csv')
    except Exception:
        df = pd.read_excel('data/volcano.xlsx', engine='openpyxl')
        print('Cargado desde data/volcano.xlsx')
except Exception:
    try:
