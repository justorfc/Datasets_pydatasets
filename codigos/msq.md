...
try:
    try:
        df = pd.read_csv('data/msq.csv')
        print('Cargado desde data/msq.csv')
    except Exception:
        df = pd.read_excel('data/msq.xlsx', engine='openpyxl')
        print('Cargado desde data/msq.xlsx')
except Exception:
    try:
