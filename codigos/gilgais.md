```python
# Código Colab para dataset: gilgais
...
try:
    try:
        df = pd.read_csv('data/gilgais.csv')
        print('Cargado desde data/gilgais.csv')
    except Exception:
        df = pd.read_excel('data/gilgais.xlsx', engine='openpyxl')
        print('Cargado desde data/gilgais.xlsx')
except Exception:
    try:
