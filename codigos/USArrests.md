```python
# Código Colab para dataset: USArrests
...
try:
    try:
        ...
        print('Cargado desde data/USArrests.csv')
    except Exception:
        df = pd.read_excel('data/USArrests.xlsx', engine='openpyxl')
        print('Cargado desde data/USArrests.xlsx')
except Exception:
    try:
