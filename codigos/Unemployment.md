```python
# Código Colab para dataset: Unemployment
...
try:
    try:
        ...
        print('Cargado desde data/Unemployment.csv')
    except Exception:
        df = pd.read_excel('data/Unemployment.xlsx', engine='openpyxl')
        print('Cargado desde data/Unemployment.xlsx')
except Exception:
    try:
