```python
# Código Colab para dataset: Electricity
...
try:
    try:
        ...
        print('Cargado desde data/Electricity.csv')
    except Exception:
        df = pd.read_excel('data/Electricity.xlsx', engine='openpyxl')
        print('Cargado desde data/Electricity.xlsx')
except Exception:
    try:
