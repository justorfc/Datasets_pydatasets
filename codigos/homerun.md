```python
# Código Colab para dataset: homerun
...
try:
    try:
        df = pd.read_csv('data/homerun.csv')
        print('Cargado desde data/homerun.csv')
    except Exception:
        df = pd.read_excel('data/homerun.xlsx', engine='openpyxl')
        print('Cargado desde data/homerun.xlsx')
except Exception:
    try:
