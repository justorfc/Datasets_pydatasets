```python
# Código Colab para dataset: nitrofen
...
try:
    try:
        df = pd.read_csv('data/nitrofen.csv')
        print('Cargado desde data/nitrofen.csv')
    except Exception:
        df = pd.read_excel('data/nitrofen.xlsx', engine='openpyxl')
        print('Cargado desde data/nitrofen.xlsx')
except Exception:
    try:
