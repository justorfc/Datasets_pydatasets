...
try:
    try:
        df = pd.read_csv('data/bmt.csv')
        print('Cargado desde data/bmt.csv')
    except Exception:
        df = pd.read_excel('data/bmt.xlsx', engine='openpyxl')
        print('Cargado desde data/bmt.xlsx')
except Exception:
    try:
