```python
# Código Colab para dataset: alcohol
...
try:
    try:
        ...
        print('Cargado desde data/alcohol.csv')
    except Exception:
        df = pd.read_excel('data/alcohol.xlsx', engine='openpyxl')
        print('Cargado desde data/alcohol.xlsx')
except Exception:
    try:
