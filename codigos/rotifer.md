```python
# Código Colab para dataset: rotifer
...
try:
    try:
        df = pd.read_csv('data/rotifer.csv')
        print('Cargado desde data/rotifer.csv')
    except Exception:
        df = pd.read_excel('data/rotifer.xlsx', engine='openpyxl')
        print('Cargado desde data/rotifer.xlsx')
except Exception:
    try:
