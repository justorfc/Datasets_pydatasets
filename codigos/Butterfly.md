```python
# Código Colab para dataset: Butterfly
...
try:
    try:
        df = pd.read_csv('data/Butterfly.csv')
        print('Cargado desde data/Butterfly.csv')
    except Exception:
        df = pd.read_excel('data/Butterfly.xlsx', engine='openpyxl')
        print('Cargado desde data/Butterfly.xlsx')
except Exception:
    try:
