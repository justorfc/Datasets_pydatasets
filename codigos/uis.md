...
try:
    try:
        df = pd.read_csv('data/uis.csv')
        print('Cargado desde data/uis.csv')
    except Exception:
        df = pd.read_excel('data/uis.xlsx', engine='openpyxl')
        print('Cargado desde data/uis.xlsx')
except Exception:
    try:
