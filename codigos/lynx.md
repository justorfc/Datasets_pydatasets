```python
# Código Colab para dataset: lynx
...
try:
    try:
        df = pd.read_csv('data/lynx.csv')
        print('Cargado desde data/lynx.csv')
    except Exception:
        df = pd.read_excel('data/lynx.xlsx', engine='openpyxl')
        print('Cargado desde data/lynx.xlsx')
except Exception:
    try:
