```python
# Código Colab para dataset: galaxies
...
try:
    try:
        ...
        print('Cargado desde data/galaxies.csv')
    except Exception:
        df = pd.read_excel('data/galaxies.xlsx', engine='openpyxl')
        print('Cargado desde data/galaxies.xlsx')
except Exception:
    try:
