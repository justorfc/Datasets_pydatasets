```python
# Código Colab para dataset: leukemia
...
try:
    try:
        ...
        print('Cargado desde data/leukemia.csv')
    except Exception:
        df = pd.read_excel('data/leukemia.xlsx', engine='openpyxl')
        print('Cargado desde data/leukemia.xlsx')
except Exception:
    try:
