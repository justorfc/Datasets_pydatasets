```python
# Código Colab para dataset: Diamond
...
try:
    try:
        ...
        print('Cargado desde data/Diamond.csv')
    except Exception:
        df = pd.read_excel('data/Diamond.xlsx', engine='openpyxl')
        print('Cargado desde data/Diamond.xlsx')
except Exception:
    try:
