```python
# Código Colab para dataset: Mandel
...
try:
    try:
        df = pd.read_csv('data/Mandel.csv')
        print('Cargado desde data/Mandel.csv')
    except Exception:
        df = pd.read_excel('data/Mandel.xlsx', engine='openpyxl')
        print('Cargado desde data/Mandel.xlsx')
except Exception:
    try:
