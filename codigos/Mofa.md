```python
# Código Colab para dataset: Mofa
...
try:
    try:
        df = pd.read_csv('data/Mofa.csv')
        print('Cargado desde data/Mofa.csv')
    except Exception:
        df = pd.read_excel('data/Mofa.xlsx', engine='openpyxl')
        print('Cargado desde data/Mofa.xlsx')
except Exception:
    try:
