```python
# Código Colab para dataset: stackloss
...
try:
    try:
        ...
        print('Cargado desde data/stackloss.csv')
    except Exception:
        df = pd.read_excel('data/stackloss.xlsx', engine='openpyxl')
        print('Cargado desde data/stackloss.xlsx')
except Exception:
    try:
