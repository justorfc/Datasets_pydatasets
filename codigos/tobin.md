```python
# Código Colab para dataset: tobin
...
try:
    try:
        df = pd.read_csv('data/tobin.csv')
        print('Cargado desde data/tobin.csv')
    except Exception:
        df = pd.read_excel('data/tobin.xlsx', engine='openpyxl')
        print('Cargado desde data/tobin.xlsx')
except Exception:
    try:
