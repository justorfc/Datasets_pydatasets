```python
# Código Colab para dataset: Friendly
...
try:
    try:
        df = pd.read_csv('data/Friendly.csv')
        print('Cargado desde data/Friendly.csv')
    except Exception:
        df = pd.read_excel('data/Friendly.xlsx', engine='openpyxl')
        print('Cargado desde data/Friendly.xlsx')
except Exception:
    try:
