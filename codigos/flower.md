```python
# Código Colab para dataset: flower
...
try:
    try:
        df = pd.read_csv('data/flower.csv')
        print('Cargado desde data/flower.csv')
    except Exception:
        df = pd.read_excel('data/flower.xlsx', engine='openpyxl')
        print('Cargado desde data/flower.xlsx')
except Exception:
    try:
