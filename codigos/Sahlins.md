```python
# Código Colab para dataset: Sahlins
...
try:
    try:
        df = pd.read_csv('data/Sahlins.csv')
        print('Cargado desde data/Sahlins.csv')
    except Exception:
        df = pd.read_excel('data/Sahlins.xlsx', engine='openpyxl')
        print('Cargado desde data/Sahlins.xlsx')
except Exception:
    try:
