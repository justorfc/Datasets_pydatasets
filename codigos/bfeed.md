```python
# Código Colab para dataset: bfeed
...
try:
    try:
        df = pd.read_csv('data/bfeed.csv')
        print('Cargado desde data/bfeed.csv')
    except Exception:
        df = pd.read_excel('data/bfeed.xlsx', engine='openpyxl')
        print('Cargado desde data/bfeed.xlsx')
except Exception:
    try:
