```python
# Código Colab para dataset: Migration
...
try:
    try:
        ...
        print('Cargado desde data/Migration.csv')
    except Exception:
        df = pd.read_excel('data/Migration.xlsx', engine='openpyxl')
        print('Cargado desde data/Migration.xlsx')
except Exception:
    try:
