```python
# Código Colab para dataset: danish
...
try:
    try:
        df = pd.read_csv('data/danish.csv')
        print('Cargado desde data/danish.csv')
    except Exception:
        df = pd.read_excel('data/danish.xlsx', engine='openpyxl')
        print('Cargado desde data/danish.xlsx')
except Exception:
    try:
