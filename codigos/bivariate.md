```python
# Código Colab para dataset: bivariate
...
try:
    try:
        df = pd.read_csv('data/bivariate.csv')
        print('Cargado desde data/bivariate.csv')
    except Exception:
        df = pd.read_excel('data/bivariate.xlsx', engine='openpyxl')
        print('Cargado desde data/bivariate.xlsx')
except Exception:
    try:
