```python
# Código Colab para dataset: cloud
...
try:
    try:
        df = pd.read_csv('data/cloud.csv')
        print('Cargado desde data/cloud.csv')
    except Exception:
        df = pd.read_excel('data/cloud.xlsx', engine='openpyxl')
        print('Cargado desde data/cloud.xlsx')
except Exception:
    try:
