```python
# Código Colab para dataset: Ginzberg
...
try:
    try:
        df = pd.read_csv('data/Ginzberg.csv')
        print('Cargado desde data/Ginzberg.csv')
    except Exception:
        df = pd.read_excel('data/Ginzberg.xlsx', engine='openpyxl')
        print('Cargado desde data/Ginzberg.xlsx')
except Exception:
    try:
