```python
# Código Colab para dataset: medpar
...
try:
    try:
        df = pd.read_csv('data/medpar.csv')
        print('Cargado desde data/medpar.csv')
    except Exception:
        df = pd.read_excel('data/medpar.xlsx', engine='openpyxl')
        print('Cargado desde data/medpar.xlsx')
except Exception:
    try:
