```python
# Código Colab para dataset: shuttle
...
try:
    try:
        ...
        print('Cargado desde data/shuttle.csv')
    except Exception:
        df = pd.read_excel('data/shuttle.xlsx', engine='openpyxl')
        print('Cargado desde data/shuttle.xlsx')
except Exception:
    try:
