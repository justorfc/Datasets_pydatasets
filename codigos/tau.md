...
try:
    try:
        df = pd.read_csv('data/tau.csv')
        print('Cargado desde data/tau.csv')
    except Exception:
        df = pd.read_excel('data/tau.xlsx', engine='openpyxl')
        print('Cargado desde data/tau.xlsx')
except Exception:
    try:
