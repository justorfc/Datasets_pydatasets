```python
# Código Colab para dataset: quakes
...
try:
    try:
        ...
        print('Cargado desde data/quakes.csv')
    except Exception:
        df = pd.read_excel('data/quakes.xlsx', engine='openpyxl')
        print('Cargado desde data/quakes.xlsx')
except Exception:
    try:
