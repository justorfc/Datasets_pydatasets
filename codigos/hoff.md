```python
# Código Colab para dataset: hoff
...
try:
    try:
        df = pd.read_csv('data/hoff.csv')
        print('Cargado desde data/hoff.csv')
    except Exception:
        df = pd.read_excel('data/hoff.xlsx', engine='openpyxl')
        print('Cargado desde data/hoff.xlsx')
except Exception:
    try:
