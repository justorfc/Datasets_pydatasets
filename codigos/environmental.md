```python
# Código Colab para dataset: environmental
...
try:
    try:
        ...
        print('Cargado desde data/environmental.csv')
    except Exception:
        df = pd.read_excel('data/environmental.xlsx', engine='openpyxl')
        print('Cargado desde data/environmental.xlsx')
except Exception:
    try:
