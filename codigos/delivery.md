```python
# Código Colab para dataset: delivery
...
try:
    try:
        ...
        print('Cargado desde data/delivery.csv')
    except Exception:
        df = pd.read_excel('data/delivery.xlsx', engine='openpyxl')
        print('Cargado desde data/delivery.xlsx')
except Exception:
    try:
