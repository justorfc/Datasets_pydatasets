```python
# Código Colab para dataset: FriendFoe
...
try:
    try:
        df = pd.read_csv('data/FriendFoe.csv')
        print('Cargado desde data/FriendFoe.csv')
    except Exception:
        df = pd.read_excel('data/FriendFoe.xlsx', engine='openpyxl')
        print('Cargado desde data/FriendFoe.xlsx')
except Exception:
    try:
