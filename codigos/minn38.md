```python
# Código Colab para dataset: minn38
...
try:
    try:
        df = pd.read_csv('data/minn38.csv')
        print('Cargado desde data/minn38.csv')
    except Exception:
        df = pd.read_excel('data/minn38.xlsx', engine='openpyxl')
        print('Cargado desde data/minn38.xlsx')
except Exception:
    try:
