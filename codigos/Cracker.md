```python
# Código Colab para dataset: Cracker
...
try:
    try:
        df = pd.read_csv('data/Cracker.csv')
        print('Cargado desde data/Cracker.csv')
    except Exception:
        df = pd.read_excel('data/Cracker.xlsx', engine='openpyxl')
        print('Cargado desde data/Cracker.xlsx')
except Exception:
    try:
