```python
# Código Colab para dataset: breslow
...
try:
    try:
        df = pd.read_csv('data/breslow.csv')
        print('Cargado desde data/breslow.csv')
    except Exception:
        df = pd.read_excel('data/breslow.xlsx', engine='openpyxl')
        print('Cargado desde data/breslow.xlsx')
except Exception:
    try:
