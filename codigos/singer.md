```python
# Código Colab para dataset: singer
...
try:
    try:
        df = pd.read_csv('data/singer.csv')
        print('Cargado desde data/singer.csv')
    except Exception:
        df = pd.read_excel('data/singer.xlsx', engine='openpyxl')
        print('Cargado desde data/singer.xlsx')
except Exception:
    try:
