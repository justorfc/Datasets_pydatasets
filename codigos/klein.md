```python
# Código Colab para dataset: klein
...
try:
    try:
        df = pd.read_csv('data/klein.csv')
        print('Cargado desde data/klein.csv')
    except Exception:
        df = pd.read_excel('data/klein.xlsx', engine='openpyxl')
        print('Cargado desde data/klein.xlsx')
except Exception:
    try:
