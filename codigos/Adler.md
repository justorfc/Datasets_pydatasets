```python
# Código Colab para dataset: Adler
...
try:
    try:
        df = pd.read_csv('data/Adler.csv')
        print('Cargado desde data/Adler.csv')
    except Exception:
        df = pd.read_excel('data/Adler.xlsx', engine='openpyxl')
        print('Cargado desde data/Adler.xlsx')
except Exception:
    try:
