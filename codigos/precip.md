```python
# Código Colab para dataset: precip
...
try:
    try:
        df = pd.read_csv('data/precip.csv')
        print('Cargado desde data/precip.csv')
    except Exception:
        df = pd.read_excel('data/precip.xlsx', engine='openpyxl')
        print('Cargado desde data/precip.xlsx')
except Exception:
    try:
