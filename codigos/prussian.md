```python
# Código Colab para dataset: prussian
...
try:
    try:
        df = pd.read_csv('data/prussian.csv')
        print('Cargado desde data/prussian.csv')
    except Exception:
        df = pd.read_excel('data/prussian.xlsx', engine='openpyxl')
        print('Cargado desde data/prussian.xlsx')
except Exception:
    try:
