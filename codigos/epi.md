...
try:
    try:
        df = pd.read_csv('data/epi.csv')
        print('Cargado desde data/epi.csv')
    except Exception:
        df = pd.read_excel('data/epi.xlsx', engine='openpyxl')
        print('Cargado desde data/epi.xlsx')
except Exception:
    try:
