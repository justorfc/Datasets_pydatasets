```python
# Código Colab para dataset: bushfire
...
try:
    try:
        df = pd.read_csv('data/bushfire.csv')
        print('Cargado desde data/bushfire.csv')
    except Exception:
        df = pd.read_excel('data/bushfire.xlsx', engine='openpyxl')
        print('Cargado desde data/bushfire.xlsx')
except Exception:
    try:
