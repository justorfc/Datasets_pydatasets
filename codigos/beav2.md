```python
# Código Colab para dataset: beav2
...
try:
    try:
        df = pd.read_csv('data/beav2.csv')
        print('Cargado desde data/beav2.csv')
    except Exception:
        df = pd.read_excel('data/beav2.xlsx', engine='openpyxl')
        print('Cargado desde data/beav2.xlsx')
except Exception:
    try:
