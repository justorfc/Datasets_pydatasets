```python
# Código Colab para dataset: immi2
...
try:
    try:
        df = pd.read_csv('data/immi2.csv')
        print('Cargado desde data/immi2.csv')
    except Exception:
        df = pd.read_excel('data/immi2.xlsx', engine='openpyxl')
        print('Cargado desde data/immi2.xlsx')
except Exception:
    try:
