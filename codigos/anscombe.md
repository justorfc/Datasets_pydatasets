```python
# Código Colab para dataset: anscombe
...
try:
    try:
        ...
        print('Cargado desde data/anscombe.csv')
    except Exception:
        df = pd.read_excel('data/anscombe.xlsx', engine='openpyxl')
        print('Cargado desde data/anscombe.xlsx')
except Exception:
    try:
