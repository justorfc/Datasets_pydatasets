```python
# Código Colab para dataset: rivers
...
try:
    try:
        df = pd.read_csv('data/rivers.csv')
        print('Cargado desde data/rivers.csv')
    except Exception:
        df = pd.read_excel('data/rivers.xlsx', engine='openpyxl')
        print('Cargado desde data/rivers.xlsx')
except Exception:
    try:
