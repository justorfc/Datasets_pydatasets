```python
# Código Colab para dataset: genotype
...
try:
    try:
        ...
        print('Cargado desde data/genotype.csv')
    except Exception:
        df = pd.read_excel('data/genotype.xlsx', engine='openpyxl')
        print('Cargado desde data/genotype.xlsx')
except Exception:
    try:
