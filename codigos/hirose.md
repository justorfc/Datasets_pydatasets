```python
# Código Colab para dataset: hirose
...
try:
    try:
        df = pd.read_csv('data/hirose.csv')
        print('Cargado desde data/hirose.csv')
    except Exception:
        df = pd.read_excel('data/hirose.xlsx', engine='openpyxl')
        print('Cargado desde data/hirose.xlsx')
except Exception:
    try:
