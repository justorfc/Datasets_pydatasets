```python
# Código Colab para dataset: Puromycin
...
try:
    try:
        df = pd.read_csv('data/Puromycin.csv')
        print('Cargado desde data/Puromycin.csv')
    except Exception:
        df = pd.read_excel('data/Puromycin.xlsx', engine='openpyxl')
        print('Cargado desde data/Puromycin.xlsx')
except Exception:
    try:
