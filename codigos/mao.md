...
try:
    try:
        df = pd.read_csv('data/mao.csv')
        print('Cargado desde data/mao.csv')
    except Exception:
        df = pd.read_excel('data/mao.xlsx', engine='openpyxl')
        print('Cargado desde data/mao.xlsx')
except Exception:
    try:
