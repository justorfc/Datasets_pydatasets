...
try:
    try:
        df = pd.read_csv('data/OFP.csv')
        print('Cargado desde data/OFP.csv')
    except Exception:
        df = pd.read_excel('data/OFP.xlsx', engine='openpyxl')
        print('Cargado desde data/OFP.xlsx')
except Exception:
    try:
