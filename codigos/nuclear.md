```python
# Código Colab para dataset: nuclear
...
try:
    try:
        df = pd.read_csv('data/nuclear.csv')
        print('Cargado desde data/nuclear.csv')
    except Exception:
        df = pd.read_excel('data/nuclear.xlsx', engine='openpyxl')
        print('Cargado desde data/nuclear.xlsx')
except Exception:
    try:
