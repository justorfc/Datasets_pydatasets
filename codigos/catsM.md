```python
# Código Colab para dataset: catsM
...
try:
    try:
        df = pd.read_csv('data/catsM.csv')
        print('Cargado desde data/catsM.csv')
    except Exception:
        df = pd.read_excel('data/catsM.xlsx', engine='openpyxl')
        print('Cargado desde data/catsM.xlsx')
except Exception:
    try:
