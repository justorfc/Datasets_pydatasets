```python
# Código Colab para dataset: Pima.tr2
...
try:
    try:
        df = pd.read_csv('data/Pima.tr2.csv')
        print('Cargado desde data/Pima.tr2.csv')
    except Exception:
        df = pd.read_excel('data/Pima.tr2.xlsx', engine='openpyxl')
        print('Cargado desde data/Pima.tr2.xlsx')
except Exception:
    try:
