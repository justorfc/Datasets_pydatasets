```python
# Código Colab para dataset: anorexia
...
try:
    try:
        ...
        print('Cargado desde data/anorexia.csv')
    except Exception:
        df = pd.read_excel('data/anorexia.xlsx', engine='openpyxl')
        print('Cargado desde data/anorexia.xlsx')
except Exception:
    try:
