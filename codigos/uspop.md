```python
# Código Colab para dataset: uspop
...
try:
    try:
        df = pd.read_csv('data/uspop.csv')
        print('Cargado desde data/uspop.csv')
    except Exception:
        df = pd.read_excel('data/uspop.xlsx', engine='openpyxl')
        print('Cargado desde data/uspop.xlsx')
except Exception:
    try:
