```python
# Código Colab para dataset: burn
...
try:
    try:
        df = pd.read_csv('data/burn.csv')
        print('Cargado desde data/burn.csv')
    except Exception:
        df = pd.read_excel('data/burn.xlsx', engine='openpyxl')
        print('Cargado desde data/burn.xlsx')
except Exception:
    try:
