```python
# Código Colab para dataset: voting
...
try:
    try:
        ...
        print('Cargado desde data/voting.csv')
    except Exception:
        df = pd.read_excel('data/voting.xlsx', engine='openpyxl')
        print('Cargado desde data/voting.xlsx')
except Exception:
    try:
