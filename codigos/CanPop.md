```python
# Código Colab para dataset: CanPop
...
try:
    try:
        ...
        print('Cargado desde data/CanPop.csv')
    except Exception:
        df = pd.read_excel('data/CanPop.xlsx', engine='openpyxl')
        print('Cargado desde data/CanPop.xlsx')
except Exception:
    try:
