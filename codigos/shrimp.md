```python
# Código Colab para dataset: shrimp
...
try:
    try:
        df = pd.read_csv('data/shrimp.csv')
        print('Cargado desde data/shrimp.csv')
    except Exception:
        df = pd.read_excel('data/shrimp.xlsx', engine='openpyxl')
        print('Cargado desde data/shrimp.xlsx')
except Exception:
    try:
