```python
# Código Colab para dataset: Mammals
...
try:
    try:
        ...
        print('Cargado desde data/Mammals.csv')
    except Exception:
        df = pd.read_excel('data/Mammals.xlsx', engine='openpyxl')
        print('Cargado desde data/Mammals.xlsx')
except Exception:
    try:
