```python
# Código Colab para dataset: painters
...
try:
    try:
        df = pd.read_csv('data/painters.csv')
        print('Cargado desde data/painters.csv')
    except Exception:
        df = pd.read_excel('data/painters.xlsx', engine='openpyxl')
        print('Cargado desde data/painters.xlsx')
except Exception:
    try:
