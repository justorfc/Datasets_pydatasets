```python
# Código Colab para dataset: Clothing
...
try:
    try:
        ...
        print('Cargado desde data/Clothing.csv')
    except Exception:
        df = pd.read_excel('data/Clothing.xlsx', engine='openpyxl')
        print('Cargado desde data/Clothing.xlsx')
except Exception:
    try:
