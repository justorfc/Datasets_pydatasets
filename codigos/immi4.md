```python
# Código Colab para dataset: immi4
...
try:
    try:
        df = pd.read_csv('data/immi4.csv')
        print('Cargado desde data/immi4.csv')
    except Exception:
        df = pd.read_excel('data/immi4.xlsx', engine='openpyxl')
        print('Cargado desde data/immi4.xlsx')
except Exception:
    try:
