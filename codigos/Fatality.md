```python
# Código Colab para dataset: Fatality
...
try:
    try:
        ...
        print('Cargado desde data/Fatality.csv')
    except Exception:
        df = pd.read_excel('data/Fatality.xlsx', engine='openpyxl')
        print('Cargado desde data/Fatality.xlsx')
except Exception:
    try:
