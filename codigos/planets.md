```python
# Código Colab para dataset: planets
...
try:
    try:
        ...
        print('Cargado desde data/planets.csv')
    except Exception:
        df = pd.read_excel('data/planets.xlsx', engine='openpyxl')
        print('Cargado desde data/planets.xlsx')
except Exception:
    try:
