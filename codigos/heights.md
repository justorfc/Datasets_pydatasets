```python
# Código Colab para dataset: heights
...
try:
    try:
        ...
        print('Cargado desde data/heights.csv')
    except Exception:
        df = pd.read_excel('data/heights.xlsx', engine='openpyxl')
        print('Cargado desde data/heights.xlsx')
except Exception:
    try:
