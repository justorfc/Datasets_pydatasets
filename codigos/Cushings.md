```python
# Código Colab para dataset: Cushings
...
try:
    try:
        df = pd.read_csv('data/Cushings.csv')
        print('Cargado desde data/Cushings.csv')
    except Exception:
        df = pd.read_excel('data/Cushings.xlsx', engine='openpyxl')
        print('Cargado desde data/Cushings.xlsx')
except Exception:
    try:
