```python
# Código Colab para dataset: LakeHuron
...
try:
    try:
        df = pd.read_csv('data/LakeHuron.csv')
        print('Cargado desde data/LakeHuron.csv')
    except Exception:
        df = pd.read_excel('data/LakeHuron.xlsx', engine='openpyxl')
        print('Cargado desde data/LakeHuron.xlsx')
except Exception:
    try:
