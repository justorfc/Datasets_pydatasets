```python
# Código Colab para dataset: allograft
...
try:
    try:
        df = pd.read_csv('data/allograft.csv')
        print('Cargado desde data/allograft.csv')
    except Exception:
        df = pd.read_excel('data/allograft.xlsx', engine='openpyxl')
        print('Cargado desde data/allograft.xlsx')
except Exception:
    try:
