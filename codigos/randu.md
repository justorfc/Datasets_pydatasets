```python
# Código Colab para dataset: randu
...
try:
    try:
        df = pd.read_csv('data/randu.csv')
        print('Cargado desde data/randu.csv')
    except Exception:
        df = pd.read_excel('data/randu.xlsx', engine='openpyxl')
        print('Cargado desde data/randu.xlsx')
except Exception:
    try:
