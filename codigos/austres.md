```python
# Código Colab para dataset: austres
...
try:
    try:
        df = pd.read_csv('data/austres.csv')
        print('Cargado desde data/austres.csv')
    except Exception:
        df = pd.read_excel('data/austres.xlsx', engine='openpyxl')
        print('Cargado desde data/austres.xlsx')
except Exception:
    try:
