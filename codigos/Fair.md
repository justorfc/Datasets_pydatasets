```python
# Código Colab para dataset: Fair
...
try:
    try:
        df = pd.read_csv('data/Fair.csv')
        print('Cargado desde data/Fair.csv')
    except Exception:
        df = pd.read_excel('data/Fair.xlsx', engine='openpyxl')
        print('Cargado desde data/Fair.xlsx')
except Exception:
    try:
