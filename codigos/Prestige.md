```python
# Código Colab para dataset: Prestige
...
try:
    try:
        ...
        print('Cargado desde data/Prestige.csv')
    except Exception:
        df = pd.read_excel('data/Prestige.xlsx', engine='openpyxl')
        print('Cargado desde data/Prestige.xlsx')
except Exception:
    try:
