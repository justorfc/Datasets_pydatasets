```python
# Código Colab para dataset: downs.bc
...
try:
    try:
        df = pd.read_csv('data/downs.bc.csv')
        print('Cargado desde data/downs.bc.csv')
    except Exception:
        df = pd.read_excel('data/downs.bc.xlsx', engine='openpyxl')
        print('Cargado desde data/downs.bc.xlsx')
except Exception:
    try:
