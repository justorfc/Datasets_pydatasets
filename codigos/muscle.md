```python
# Código Colab para dataset: muscle
...
try:
    try:
        df = pd.read_csv('data/muscle.csv')
        print('Cargado desde data/muscle.csv')
    except Exception:
        df = pd.read_excel('data/muscle.xlsx', engine='openpyxl')
        print('Cargado desde data/muscle.xlsx')
except Exception:
    try:
