```python
# Código Colab para dataset: msleep
...
try:
    try:
        ...
        print('Cargado desde data/msleep.csv')
    except Exception:
        df = pd.read_excel('data/msleep.xlsx', engine='openpyxl')
        print('Cargado desde data/msleep.xlsx')
except Exception:
    try:
