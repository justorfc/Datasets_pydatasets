```python
# Código Colab para dataset: nwtco
...
try:
    try:
        df = pd.read_csv('data/nwtco.csv')
        print('Cargado desde data/nwtco.csv')
    except Exception:
        df = pd.read_excel('data/nwtco.xlsx', engine='openpyxl')
        print('Cargado desde data/nwtco.xlsx')
except Exception:
    try:
