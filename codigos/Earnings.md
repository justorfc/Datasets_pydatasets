```python
# Código Colab para dataset: Earnings
...
try:
    try:
        ...
        print('Cargado desde data/Earnings.csv')
    except Exception:
        df = pd.read_excel('data/Earnings.xlsx', engine='openpyxl')
        print('Cargado desde data/Earnings.xlsx')
except Exception:
    try:
