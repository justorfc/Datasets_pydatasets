```python
# Código Colab para dataset: income
...
try:
    try:
        ...
        print('Cargado desde data/income.csv')
    except Exception:
        df = pd.read_excel('data/income.xlsx', engine='openpyxl')
        print('Cargado desde data/income.xlsx')
except Exception:
    try:
