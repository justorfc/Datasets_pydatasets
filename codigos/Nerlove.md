```python
# Código Colab para dataset: Nerlove
...
try:
    try:
        df = pd.read_csv('data/Nerlove.csv')
        print('Cargado desde data/Nerlove.csv')
    except Exception:
        df = pd.read_excel('data/Nerlove.xlsx', engine='openpyxl')
        print('Cargado desde data/Nerlove.xlsx')
except Exception:
    try:
