```python
# Código Colab para dataset: synth.tr
...
try:
    try:
        df = pd.read_csv('data/synth.tr.csv')
        print('Cargado desde data/synth.tr.csv')
    except Exception:
        df = pd.read_excel('data/synth.tr.xlsx', engine='openpyxl')
        print('Cargado desde data/synth.tr.xlsx')
except Exception:
    try:
