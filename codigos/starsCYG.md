```python
# Código Colab para dataset: starsCYG
...
try:
    try:
        df = pd.read_csv('data/starsCYG.csv')
        print('Cargado desde data/starsCYG.csv')
    except Exception:
        df = pd.read_excel('data/starsCYG.xlsx', engine='openpyxl')
        print('Cargado desde data/starsCYG.xlsx')
except Exception:
    try:
