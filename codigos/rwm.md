...
try:
    try:
        df = pd.read_csv('data/rwm.csv')
        print('Cargado desde data/rwm.csv')
    except Exception:
        df = pd.read_excel('data/rwm.xlsx', engine='openpyxl')
        print('Cargado desde data/rwm.xlsx')
except Exception:
    try:
