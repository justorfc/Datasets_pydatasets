```python
# Código Colab para dataset: Titanic
...
try:
    try:
        ...
        print('Cargado desde data/Titanic.csv')
    except Exception:
        df = pd.read_excel('data/Titanic.xlsx', engine='openpyxl')
        print('Cargado desde data/Titanic.xlsx')
except Exception:
    try:
