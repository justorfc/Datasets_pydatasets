```python
# Código Colab para dataset: Yogurt
...
try:
    try:
        ...
        print('Cargado desde data/Yogurt.csv')
    except Exception:
        df = pd.read_excel('data/Yogurt.xlsx', engine='openpyxl')
        print('Cargado desde data/Yogurt.xlsx')
except Exception:
    try:
