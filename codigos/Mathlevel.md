```python
# Código Colab para dataset: Mathlevel
...
try:
    try:
        df = pd.read_csv('data/Mathlevel.csv')
        print('Cargado desde data/Mathlevel.csv')
    except Exception:
        df = pd.read_excel('data/Mathlevel.xlsx', engine='openpyxl')
        print('Cargado desde data/Mathlevel.xlsx')
except Exception:
    try:
