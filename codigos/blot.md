```python
# Código Colab para dataset: blot
...
try:
    try:
        df = pd.read_csv('data/blot.csv')
        print('Cargado desde data/blot.csv')
    except Exception:
        df = pd.read_excel('data/blot.xlsx', engine='openpyxl')
        print('Cargado desde data/blot.xlsx')
except Exception:
    try:
