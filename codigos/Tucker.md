```python
# Código Colab para dataset: Tucker
...
try:
    try:
        df = pd.read_csv('data/Tucker.csv')
        print('Cargado desde data/Tucker.csv')
    except Exception:
        df = pd.read_excel('data/Tucker.xlsx', engine='openpyxl')
        print('Cargado desde data/Tucker.xlsx')
except Exception:
    try:
