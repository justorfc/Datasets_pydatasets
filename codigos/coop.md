```python
# Código Colab para dataset: coop
...
try:
    try:
        df = pd.read_csv('data/coop.csv')
        print('Cargado desde data/coop.csv')
    except Exception:
        df = pd.read_excel('data/coop.xlsx', engine='openpyxl')
        print('Cargado desde data/coop.xlsx')
except Exception:
    try:
