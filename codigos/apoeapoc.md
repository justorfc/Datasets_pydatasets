```python
# Código Colab para dataset: apoeapoc
...
try:
    try:
        df = pd.read_csv('data/apoeapoc.csv')
        print('Cargado desde data/apoeapoc.csv')
    except Exception:
        df = pd.read_excel('data/apoeapoc.xlsx', engine='openpyxl')
        print('Cargado desde data/apoeapoc.xlsx')
except Exception:
    try:
