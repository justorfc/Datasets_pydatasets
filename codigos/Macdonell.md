```python
# Código Colab para dataset: Macdonell
...
try:
    try:
        df = pd.read_csv('data/Macdonell.csv')
        print('Cargado desde data/Macdonell.csv')
    except Exception:
        df = pd.read_excel('data/Macdonell.xlsx', engine='openpyxl')
        print('Cargado desde data/Macdonell.xlsx')
except Exception:
    try:
