```python
# Código Colab para dataset: siemens
...
try:
    try:
        df = pd.read_csv('data/siemens.csv')
        print('Cargado desde data/siemens.csv')
    except Exception:
        df = pd.read_excel('data/siemens.xlsx', engine='openpyxl')
        print('Cargado desde data/siemens.xlsx')
except Exception:
    try:
