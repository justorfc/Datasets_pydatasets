```python
# Código Colab para dataset: possumDiv
...
try:
    try:
        df = pd.read_csv('data/possumDiv.csv')
        print('Cargado desde data/possumDiv.csv')
    except Exception:
        df = pd.read_excel('data/possumDiv.xlsx', engine='openpyxl')
        print('Cargado desde data/possumDiv.xlsx')
except Exception:
    try:
