```python
# Código Colab para dataset: WWWusage
...
try:
    try:
        ...
        print('Cargado desde data/WWWusage.csv')
    except Exception:
        df = pd.read_excel('data/WWWusage.xlsx', engine='openpyxl')
        print('Cargado desde data/WWWusage.xlsx')
except Exception:
    try:
