```python
# Código Colab para dataset: midwest
...
try:
    try:
        ...
        print('Cargado desde data/midwest.csv')
    except Exception:
        df = pd.read_excel('data/midwest.xlsx', engine='openpyxl')
        print('Cargado desde data/midwest.xlsx')
except Exception:
    try:
