```python
# Código Colab para dataset: mfblong
...
try:
    try:
        df = pd.read_csv('data/mfblong.csv')
        print('Cargado desde data/mfblong.csv')
    except Exception:
        df = pd.read_excel('data/mfblong.xlsx', engine='openpyxl')
        print('Cargado desde data/mfblong.xlsx')
except Exception:
    try:
