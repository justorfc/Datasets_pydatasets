```python
# Código Colab para dataset: nottem
...
try:
    try:
        df = pd.read_csv('data/nottem.csv')
        print('Cargado desde data/nottem.csv')
    except Exception:
        df = pd.read_excel('data/nottem.xlsx', engine='openpyxl')
        print('Cargado desde data/nottem.xlsx')
except Exception:
    try:
