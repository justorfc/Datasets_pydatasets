```python
# Código Colab para dataset: Traffic
...
try:
    try:
        ...
        print('Cargado desde data/Traffic.csv')
    except Exception:
        df = pd.read_excel('data/Traffic.xlsx', engine='openpyxl')
        print('Cargado desde data/Traffic.xlsx')
except Exception:
    try:
