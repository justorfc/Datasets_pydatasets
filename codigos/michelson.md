```python
# Código Colab para dataset: michelson
...
try:
    try:
        df = pd.read_csv('data/michelson.csv')
        print('Cargado desde data/michelson.csv')
    except Exception:
        df = pd.read_excel('data/michelson.xlsx', engine='openpyxl')
        print('Cargado desde data/michelson.xlsx')
except Exception:
    try:
