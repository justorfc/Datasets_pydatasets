```python
# Código Colab para dataset: beav1
...
try:
    try:
        df = pd.read_csv('data/beav1.csv')
        print('Cargado desde data/beav1.csv')
    except Exception:
        df = pd.read_excel('data/beav1.xlsx', engine='openpyxl')
        print('Cargado desde data/beav1.xlsx')
except Exception:
    try:
