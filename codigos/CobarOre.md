```python
# Código Colab para dataset: CobarOre
...
try:
    try:
        df = pd.read_csv('data/CobarOre.csv')
        print('Cargado desde data/CobarOre.csv')
    except Exception:
        df = pd.read_excel('data/CobarOre.xlsx', engine='openpyxl')
        print('Cargado desde data/CobarOre.xlsx')
except Exception:
    try:
