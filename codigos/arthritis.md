```python
# Código Colab para dataset: arthritis
...
try:
    try:
        ...
        print('Cargado desde data/arthritis.csv')
    except Exception:
        df = pd.read_excel('data/arthritis.xlsx', engine='openpyxl')
        print('Cargado desde data/arthritis.xlsx')
except Exception:
    try:
