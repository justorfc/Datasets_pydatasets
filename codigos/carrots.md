```python
# Código Colab para dataset: carrots
...
try:
    try:
        df = pd.read_csv('data/carrots.csv')
        print('Cargado desde data/carrots.csv')
    except Exception:
        df = pd.read_excel('data/carrots.xlsx', engine='openpyxl')
        print('Cargado desde data/carrots.xlsx')
except Exception:
    try:
