```python
# Código Colab para dataset: remission
...
try:
    try:
        df = pd.read_csv('data/remission.csv')
        print('Cargado desde data/remission.csv')
    except Exception:
        df = pd.read_excel('data/remission.xlsx', engine='openpyxl')
        print('Cargado desde data/remission.xlsx')
except Exception:
    try:
