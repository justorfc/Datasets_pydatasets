```python
# Código Colab para dataset: amis
...
try:
    try:
        df = pd.read_csv('data/amis.csv')
        print('Cargado desde data/amis.csv')
    except Exception:
        df = pd.read_excel('data/amis.xlsx', engine='openpyxl')
        print('Cargado desde data/amis.xlsx')
except Exception:
    try:
