```python
# Código Colab para dataset: ducks
...
try:
    try:
        df = pd.read_csv('data/ducks.csv')
        print('Cargado desde data/ducks.csv')
    except Exception:
        df = pd.read_excel('data/ducks.xlsx', engine='openpyxl')
        print('Cargado desde data/ducks.xlsx')
except Exception:
    try:
