```python
# Código Colab para dataset: Caschool
...
try:
    try:
        ...
        print('Cargado desde data/Caschool.csv')
    except Exception:
        df = pd.read_excel('data/Caschool.xlsx', engine='openpyxl')
        print('Cargado desde data/Caschool.xlsx')
except Exception:
    try:
