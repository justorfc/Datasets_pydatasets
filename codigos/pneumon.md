```python
# Código Colab para dataset: pneumon
...
try:
    try:
        df = pd.read_csv('data/pneumon.csv')
        print('Cargado desde data/pneumon.csv')
    except Exception:
        df = pd.read_excel('data/pneumon.xlsx', engine='openpyxl')
        print('Cargado desde data/pneumon.xlsx')
except Exception:
    try:
