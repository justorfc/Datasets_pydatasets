```python
# Código Colab para dataset: car90
...
try:
    try:
        df = pd.read_csv('data/car90.csv')
        print('Cargado desde data/car90.csv')
    except Exception:
        df = pd.read_excel('data/car90.xlsx', engine='openpyxl')
        print('Cargado desde data/car90.xlsx')
except Exception:
    try:
