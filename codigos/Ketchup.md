```python
# Código Colab para dataset: Ketchup
...
try:
    try:
        df = pd.read_csv('data/Ketchup.csv')
        print('Cargado desde data/Ketchup.csv')
    except Exception:
        df = pd.read_excel('data/Ketchup.xlsx', engine='openpyxl')
        print('Cargado desde data/Ketchup.xlsx')
except Exception:
    try:
