```python
# Código Colab para dataset: channing
...
try:
    try:
        df = pd.read_csv('data/channing.csv')
        print('Cargado desde data/channing.csv')
    except Exception:
        df = pd.read_excel('data/channing.xlsx', engine='openpyxl')
        print('Cargado desde data/channing.xlsx')
except Exception:
    try:
