```python
# Código Colab para dataset: DavisThin
...
try:
    try:
        df = pd.read_csv('data/DavisThin.csv')
        print('Cargado desde data/DavisThin.csv')
    except Exception:
        df = pd.read_excel('data/DavisThin.xlsx', engine='openpyxl')
        print('Cargado desde data/DavisThin.xlsx')
except Exception:
    try:
