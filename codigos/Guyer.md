```python
# Código Colab para dataset: Guyer
...
try:
    try:
        df = pd.read_csv('data/Guyer.csv')
        print('Cargado desde data/Guyer.csv')
    except Exception:
        df = pd.read_excel('data/Guyer.xlsx', engine='openpyxl')
        print('Cargado desde data/Guyer.xlsx')
except Exception:
    try:
