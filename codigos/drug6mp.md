```python
# Código Colab para dataset: drug6mp
...
try:
    try:
        df = pd.read_csv('data/drug6mp.csv')
        print('Cargado desde data/drug6mp.csv')
    except Exception:
        df = pd.read_excel('data/drug6mp.xlsx', engine='openpyxl')
        print('Cargado desde data/drug6mp.xlsx')
except Exception:
    try:
