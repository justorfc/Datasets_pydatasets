```python
# Código Colab para dataset: logan
...
try:
    try:
        df = pd.read_csv('data/logan.csv')
        print('Cargado desde data/logan.csv')
    except Exception:
        df = pd.read_excel('data/logan.xlsx', engine='openpyxl')
        print('Cargado desde data/logan.xlsx')
except Exception:
    try:
