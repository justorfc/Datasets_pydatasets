```python
# Código Colab para dataset: toxicity
...
try:
    try:
        ...
        print('Cargado desde data/toxicity.csv')
    except Exception:
        df = pd.read_excel('data/toxicity.xlsx', engine='openpyxl')
        print('Cargado desde data/toxicity.xlsx')
except Exception:
    try:
