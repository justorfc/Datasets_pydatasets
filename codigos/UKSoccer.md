```python
# Código Colab para dataset: UKSoccer
...
try:
    try:
        df = pd.read_csv('data/UKSoccer.csv')
        print('Cargado desde data/UKSoccer.csv')
    except Exception:
        df = pd.read_excel('data/UKSoccer.xlsx', engine='openpyxl')
        print('Cargado desde data/UKSoccer.xlsx')
except Exception:
    try:
