```python
# Código Colab para dataset: kidtran
...
try:
    try:
        df = pd.read_csv('data/kidtran.csv')
        print('Cargado desde data/kidtran.csv')
    except Exception:
        df = pd.read_excel('data/kidtran.xlsx', engine='openpyxl')
        print('Cargado desde data/kidtran.xlsx')
except Exception:
    try:
