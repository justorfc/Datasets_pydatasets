```python
# Código Colab para dataset: Trucks
...
try:
    try:
        ...
        print('Cargado desde data/Trucks.csv')
    except Exception:
        df = pd.read_excel('data/Trucks.xlsx', engine='openpyxl')
        print('Cargado desde data/Trucks.xlsx')
except Exception:
    try:
