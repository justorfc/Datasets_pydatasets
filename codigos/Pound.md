```python
# Código Colab para dataset: Pound
...
try:
    try:
        df = pd.read_csv('data/Pound.csv')
        print('Cargado desde data/Pound.csv')
    except Exception:
        df = pd.read_excel('data/Pound.xlsx', engine='openpyxl')
        print('Cargado desde data/Pound.xlsx')
except Exception:
    try:
