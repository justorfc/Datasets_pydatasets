```python
# Código Colab para dataset: birthwt
...
try:
    try:
        ...
        print('Cargado desde data/birthwt.csv')
    except Exception:
        df = pd.read_excel('data/birthwt.xlsx', engine='openpyxl')
        print('Cargado desde data/birthwt.xlsx')
except Exception:
    try:
