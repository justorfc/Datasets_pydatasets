```python
# Código Colab para dataset: Rabbit
...
try:
    try:
        df = pd.read_csv('data/Rabbit.csv')
        print('Cargado desde data/Rabbit.csv')
    except Exception:
        df = pd.read_excel('data/Rabbit.xlsx', engine='openpyxl')
        print('Cargado desde data/Rabbit.xlsx')
except Exception:
    try:
