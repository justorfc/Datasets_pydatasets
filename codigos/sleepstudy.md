```python
# Código Colab para dataset: sleepstudy
...
try:
    try:
        ...
        print('Cargado desde data/sleepstudy.csv')
    except Exception:
        df = pd.read_excel('data/sleepstudy.xlsx', engine='openpyxl')
        print('Cargado desde data/sleepstudy.xlsx')
except Exception:
    try:
