```python
# Código Colab para dataset: InsectSprays
...
try:
    try:
        ...
        print('Cargado desde data/InsectSprays.csv')
    except Exception:
        df = pd.read_excel('data/InsectSprays.xlsx', engine='openpyxl')
        print('Cargado desde data/InsectSprays.xlsx')
except Exception:
    try:
