```python
# Código Colab para dataset: Weimar
...
try:
    try:
        df = pd.read_csv('data/Weimar.csv')
        print('Cargado desde data/Weimar.csv')
    except Exception:
        df = pd.read_excel('data/Weimar.xlsx', engine='openpyxl')
        print('Cargado desde data/Weimar.xlsx')
except Exception:
    try:
