...
try:
    try:
        df = pd.read_csv('data/PD.csv')
        print('Cargado desde data/PD.csv')
    except Exception:
        df = pd.read_excel('data/PD.xlsx', engine='openpyxl')
        print('Cargado desde data/PD.xlsx')
except Exception:
    try:
