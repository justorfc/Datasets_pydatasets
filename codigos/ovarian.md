```python
# Código Colab para dataset: ovarian
...
try:
    try:
        ...
        print('Cargado desde data/ovarian.csv')
    except Exception:
        df = pd.read_excel('data/ovarian.xlsx', engine='openpyxl')
        print('Cargado desde data/ovarian.xlsx')
except Exception:
    try:
