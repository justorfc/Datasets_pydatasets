```python
# Código Colab para dataset: epi.bfi
...
try:
    try:
        df = pd.read_csv('data/epi.bfi.csv')
        print('Cargado desde data/epi.bfi.csv')
    except Exception:
        df = pd.read_excel('data/epi.bfi.xlsx', engine='openpyxl')
        print('Cargado desde data/epi.bfi.xlsx')
except Exception:
    try:
