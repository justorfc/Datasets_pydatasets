```python
# Código Colab para dataset: polyps3
...
try:
    try:
        df = pd.read_csv('data/polyps3.csv')
        print('Cargado desde data/polyps3.csv')
    except Exception:
        df = pd.read_excel('data/polyps3.xlsx', engine='openpyxl')
        print('Cargado desde data/polyps3.xlsx')
except Exception:
    try:
