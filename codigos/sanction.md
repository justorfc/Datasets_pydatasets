```python
# Código Colab para dataset: sanction
...
try:
    try:
        df = pd.read_csv('data/sanction.csv')
        print('Cargado desde data/sanction.csv')
    except Exception:
        df = pd.read_excel('data/sanction.xlsx', engine='openpyxl')
        print('Cargado desde data/sanction.xlsx')
except Exception:
    try:
