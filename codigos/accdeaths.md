```python
# Código Colab para dataset: accdeaths
...
try:
    try:
        df = pd.read_csv('data/accdeaths.csv')
        print('Cargado desde data/accdeaths.csv')
    except Exception:
        df = pd.read_excel('data/accdeaths.xlsx', engine='openpyxl')
        print('Cargado desde data/accdeaths.xlsx')
except Exception:
    try:
