```python
# Código Colab para dataset: nep499
...
try:
    try:
        df = pd.read_csv('data/nep499.csv')
        print('Cargado desde data/nep499.csv')
    except Exception:
        df = pd.read_excel('data/nep499.xlsx', engine='openpyxl')
        print('Cargado desde data/nep499.xlsx')
except Exception:
    try:
