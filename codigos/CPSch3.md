```python
# Código Colab para dataset: CPSch3
...
try:
    try:
        df = pd.read_csv('data/CPSch3.csv')
        print('Cargado desde data/CPSch3.csv')
    except Exception:
        df = pd.read_excel('data/CPSch3.xlsx', engine='openpyxl')
        print('Cargado desde data/CPSch3.xlsx')
except Exception:
    try:
