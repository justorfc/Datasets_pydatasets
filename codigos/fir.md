...
try:
    try:
        df = pd.read_csv('data/fir.csv')
        print('Cargado desde data/fir.csv')
    except Exception:
        df = pd.read_excel('data/fir.xlsx', engine='openpyxl')
        print('Cargado desde data/fir.xlsx')
except Exception:
    try:
