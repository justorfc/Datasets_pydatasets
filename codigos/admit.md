```python
# Código Colab para dataset: admit
...
try:
    try:
        df = pd.read_csv('data/admit.csv')
        print('Cargado desde data/admit.csv')
    except Exception:
        df = pd.read_excel('data/admit.xlsx', engine='openpyxl')
        print('Cargado desde data/admit.xlsx')
except Exception:
    try:
