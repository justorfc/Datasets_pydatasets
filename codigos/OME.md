...
try:
    try:
        df = pd.read_csv('data/OME.csv')
        print('Cargado desde data/OME.csv')
    except Exception:
        df = pd.read_excel('data/OME.xlsx', engine='openpyxl')
        print('Cargado desde data/OME.xlsx')
except Exception:
    try:
