```python
# Código Colab para dataset: vaso
...
try:
    try:
        df = pd.read_csv('data/vaso.csv')
        print('Cargado desde data/vaso.csv')
    except Exception:
        df = pd.read_excel('data/vaso.xlsx', engine='openpyxl')
        print('Cargado desde data/vaso.xlsx')
except Exception:
    try:
