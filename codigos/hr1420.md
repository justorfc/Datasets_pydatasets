```python
# Código Colab para dataset: hr1420
...
try:
    try:
        df = pd.read_csv('data/hr1420.csv')
        print('Cargado desde data/hr1420.csv')
    except Exception:
        df = pd.read_excel('data/hr1420.xlsx', engine='openpyxl')
        print('Cargado desde data/hr1420.xlsx')
except Exception:
    try:
