```python
# Código Colab para dataset: VonBort
...
try:
    try:
        ...
        print('Cargado desde data/VonBort.csv')
    except Exception:
        df = pd.read_excel('data/VonBort.xlsx', engine='openpyxl')
        print('Cargado desde data/VonBort.xlsx')
except Exception:
    try:
