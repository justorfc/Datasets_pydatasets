```python
# Código Colab para dataset: UnempDur
...
try:
    try:
        df = pd.read_csv('data/UnempDur.csv')
        print('Cargado desde data/UnempDur.csv')
    except Exception:
        df = pd.read_excel('data/UnempDur.xlsx', engine='openpyxl')
        print('Cargado desde data/UnempDur.xlsx')
except Exception:
    try:
