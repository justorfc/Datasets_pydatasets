```python
# Código Colab para dataset: turnout
...
try:
    try:
        ...
        print('Cargado desde data/turnout.csv')
    except Exception:
        df = pd.read_excel('data/turnout.xlsx', engine='openpyxl')
        print('Cargado desde data/turnout.xlsx')
except Exception:
    try:
