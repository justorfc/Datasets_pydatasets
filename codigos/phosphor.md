```python
# Código Colab para dataset: phosphor
...
try:
    try:
        df = pd.read_csv('data/phosphor.csv')
        print('Cargado desde data/phosphor.csv')
    except Exception:
        df = pd.read_excel('data/phosphor.xlsx', engine='openpyxl')
        print('Cargado desde data/phosphor.xlsx')
except Exception:
    try:
