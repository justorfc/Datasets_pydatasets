```python
# Código Colab para dataset: mtcars
...
try:
    try:
        ...
        print('Cargado desde data/mtcars.csv')
    except Exception:
        df = pd.read_excel('data/mtcars.xlsx', engine='openpyxl')
        print('Cargado desde data/mtcars.xlsx')
except Exception:
    try:
