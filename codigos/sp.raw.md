```python
# Código Colab para dataset: sp.raw
...
try:
    try:
        df = pd.read_csv('data/sp.raw.csv')
        print('Cargado desde data/sp.raw.csv')
    except Exception:
        df = pd.read_excel('data/sp.raw.xlsx', engine='openpyxl')
        print('Cargado desde data/sp.raw.xlsx')
except Exception:
    try:
