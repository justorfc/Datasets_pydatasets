```python
# Código Colab para dataset: cake
...
try:
    try:
        df = pd.read_csv('data/cake.csv')
        print('Cargado desde data/cake.csv')
    except Exception:
        df = pd.read_excel('data/cake.xlsx', engine='openpyxl')
        print('Cargado desde data/cake.xlsx')
except Exception:
    try:
