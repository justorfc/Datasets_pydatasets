```python
# Código Colab para dataset: GaltonFamilies
...
try:
    try:
        ...
        print('Cargado desde data/GaltonFamilies.csv')
    except Exception:
        df = pd.read_excel('data/GaltonFamilies.xlsx', engine='openpyxl')
        print('Cargado desde data/GaltonFamilies.xlsx')
except Exception:
    try:
