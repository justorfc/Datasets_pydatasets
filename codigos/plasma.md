```python
# Código Colab para dataset: plasma
...
try:
    try:
        df = pd.read_csv('data/plasma.csv')
        print('Cargado desde data/plasma.csv')
    except Exception:
        df = pd.read_excel('data/plasma.xlsx', engine='openpyxl')
        print('Cargado desde data/plasma.xlsx')
except Exception:
    try:
