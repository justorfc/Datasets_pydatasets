```python
# Código Colab para dataset: azdrg112
...
try:
    try:
        df = pd.read_csv('data/azdrg112.csv')
        print('Cargado desde data/azdrg112.csv')
    except Exception:
        df = pd.read_excel('data/azdrg112.xlsx', engine='openpyxl')
        print('Cargado desde data/azdrg112.xlsx')
except Exception:
    try:
