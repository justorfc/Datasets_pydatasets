```python
# Código Colab para dataset: Zelig.url
...
try:
    try:
        df = pd.read_csv('data/Zelig.url.csv')
        print('Cargado desde data/Zelig.url.csv')
    except Exception:
        df = pd.read_excel('data/Zelig.url.xlsx', engine='openpyxl')
        print('Cargado desde data/Zelig.url.xlsx')
except Exception:
    try:
