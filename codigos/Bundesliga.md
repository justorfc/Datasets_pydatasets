```python
# Código Colab para dataset: Bundesliga
...
try:
    try:
        ...
        print('Cargado desde data/Bundesliga.csv')
    except Exception:
        df = pd.read_excel('data/Bundesliga.xlsx', engine='openpyxl')
        print('Cargado desde data/Bundesliga.xlsx')
except Exception:
    try:
