```python
# Código Colab para dataset: affairs
...
try:
    try:
        ...
        print('Cargado desde data/affairs.csv')
    except Exception:
        df = pd.read_excel('data/affairs.xlsx', engine='openpyxl')
        print('Cargado desde data/affairs.xlsx')
except Exception:
    try:
