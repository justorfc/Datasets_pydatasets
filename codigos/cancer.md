```python
# Código Colab para dataset: cancer
...
try:
    try:
        ...
        print('Cargado desde data/cancer.csv')
    except Exception:
        df = pd.read_excel('data/cancer.xlsx', engine='openpyxl')
        print('Cargado desde data/cancer.xlsx')
except Exception:
    try:
