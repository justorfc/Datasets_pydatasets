```python
# Código Colab para dataset: paulsen
...
try:
    try:
        df = pd.read_csv('data/paulsen.csv')
        print('Cargado desde data/paulsen.csv')
    except Exception:
        df = pd.read_excel('data/paulsen.xlsx', engine='openpyxl')
        print('Cargado desde data/paulsen.xlsx')
except Exception:
    try:
