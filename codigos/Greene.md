```python
# Código Colab para dataset: Greene
...
try:
    try:
        df = pd.read_csv('data/Greene.csv')
        print('Cargado desde data/Greene.csv')
    except Exception:
        df = pd.read_excel('data/Greene.xlsx', engine='openpyxl')
        print('Cargado desde data/Greene.xlsx')
except Exception:
    try:
