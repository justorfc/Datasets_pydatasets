```python
# Código Colab para dataset: pressure
...
try:
    try:
        ...
        print('Cargado desde data/pressure.csv')
    except Exception:
        df = pd.read_excel('data/pressure.xlsx', engine='openpyxl')
        print('Cargado desde data/pressure.xlsx')
except Exception:
    try:
