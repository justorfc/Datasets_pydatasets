```python
# Código Colab para dataset: infert
...
try:
    try:
        df = pd.read_csv('data/infert.csv')
        print('Cargado desde data/infert.csv')
    except Exception:
        df = pd.read_excel('data/infert.xlsx', engine='openpyxl')
        print('Cargado desde data/infert.xlsx')
except Exception:
    try:
