```python
# Código Colab para dataset: immer
...
try:
    try:
        df = pd.read_csv('data/immer.csv')
        print('Cargado desde data/immer.csv')
    except Exception:
        df = pd.read_excel('data/immer.xlsx', engine='openpyxl')
        print('Cargado desde data/immer.xlsx')
except Exception:
    try:
