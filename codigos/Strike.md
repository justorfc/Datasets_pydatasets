```python
# Código Colab para dataset: Strike
...
try:
    try:
        df = pd.read_csv('data/Strike.csv')
        print('Cargado desde data/Strike.csv')
    except Exception:
        df = pd.read_excel('data/Strike.xlsx', engine='openpyxl')
        print('Cargado desde data/Strike.xlsx')
except Exception:
    try:
