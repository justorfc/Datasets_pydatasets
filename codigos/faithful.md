```python
# Código Colab para dataset: faithful
...
try:
    try:
        ...
        print('Cargado desde data/faithful.csv')
    except Exception:
        df = pd.read_excel('data/faithful.xlsx', engine='openpyxl')
        print('Cargado desde data/faithful.xlsx')
except Exception:
    try:
