```python
# Código Colab para dataset: btrial
...
try:
    try:
        df = pd.read_csv('data/btrial.csv')
        print('Cargado desde data/btrial.csv')
    except Exception:
        df = pd.read_excel('data/btrial.xlsx', engine='openpyxl')
        print('Cargado desde data/btrial.xlsx')
except Exception:
    try:
