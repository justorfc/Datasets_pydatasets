```python
# Código Colab para dataset: portpirie
...
try:
    try:
        df = pd.read_csv('data/portpirie.csv')
        print('Cargado desde data/portpirie.csv')
    except Exception:
        df = pd.read_excel('data/portpirie.xlsx', engine='openpyxl')
        print('Cargado desde data/portpirie.xlsx')
except Exception:
    try:
