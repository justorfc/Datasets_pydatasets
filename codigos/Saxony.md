```python
# Código Colab para dataset: Saxony
...
try:
    try:
        df = pd.read_csv('data/Saxony.csv')
        print('Cargado desde data/Saxony.csv')
    except Exception:
        df = pd.read_excel('data/Saxony.xlsx', engine='openpyxl')
        print('Cargado desde data/Saxony.xlsx')
except Exception:
    try:
