```python
# Código Colab para dataset: larynx
...
try:
    try:
        df = pd.read_csv('data/larynx.csv')
        print('Cargado desde data/larynx.csv')
    except Exception:
        df = pd.read_excel('data/larynx.xlsx', engine='openpyxl')
        print('Cargado desde data/larynx.xlsx')
except Exception:
    try:
