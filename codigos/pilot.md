```python
# Código Colab para dataset: pilot
...
try:
    try:
        df = pd.read_csv('data/pilot.csv')
        print('Cargado desde data/pilot.csv')
    except Exception:
        df = pd.read_excel('data/pilot.xlsx', engine='openpyxl')
        print('Cargado desde data/pilot.xlsx')
except Exception:
    try:
