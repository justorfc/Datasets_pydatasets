```python
# Código Colab para dataset: Icecream
...
try:
    try:
        ...
        print('Cargado desde data/Icecream.csv')
    except Exception:
        df = pd.read_excel('data/Icecream.xlsx', engine='openpyxl')
        print('Cargado desde data/Icecream.xlsx')
except Exception:
    try:
