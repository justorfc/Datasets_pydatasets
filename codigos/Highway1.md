```python
# Código Colab para dataset: Highway1
...
try:
    try:
        df = pd.read_csv('data/Highway1.csv')
        print('Cargado desde data/Highway1.csv')
    except Exception:
        df = pd.read_excel('data/Highway1.xlsx', engine='openpyxl')
        print('Cargado desde data/Highway1.xlsx')
except Exception:
    try:
